...
export const template = ({ title, dropdownOpen }: { title: string, dropdownOpen: boolean }) => `
    <header class="header">
        ...
        <div class="header__group">
            ...
            <div class="header__action" title="${i18n.t('general.layouts')}">
            ...
            <div class="header__action" title="${i18n.t('general.search')}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="header__action" title="${i18n.t('general.chrome')}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="header__action" title="${i18n.t('header.preferences')}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="header__profile-container">
                <div class="header__action" id="profile-trigger" title="${i18n.t('general.profile')}">
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
