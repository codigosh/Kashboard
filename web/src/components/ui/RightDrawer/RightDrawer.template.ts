    ...
    <div class="right-drawer__panel">
        <div class="right-drawer__header">
            ...
            <div class="right-drawer__user-info">
                ...
                ${(user.role?.toLowerCase() === 'admin' || user.role === 'Administrator') ? `<span class="right-drawer__role">${user.role || 'Administrator'}</span>` : ''}
            </div>
        </div>
        
        <div class="right-drawer__body">
            <div class="right-drawer__section-label">Preferences</div>
