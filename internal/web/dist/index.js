...
.avatar__initials {
    user-select: none;
        ...
        `}}if(!customElements.get("app-avatar"))customElements.define("app-avatar",Eo);y();B();no();y();var Ko=(o)=>`
...
`,Pr=(o,r)=>{if(!o)return"";if(!r)return"";if(r.is_docker)return`
    ...
    `},co=(o,r,t)=>{return`
        ...
        `:""}
    `},Oo=(o,r,t,i,n)=>{let e=t?.toLowerCase()==="admin"||t?.toLowerCase()==="administrator";return`
...
.select-option.selected:hover {
    background: rgba(var(--accent-rgb), 0.15);
        ...
        `,this.shadowRoot.getElementById("trigger")?.addEventListener("click",(t)=>{t.stopPropagation(),this.toggle()})}}if(!customElements.get("app-select"))customElements.define("app-select",Xo);var xo=`:host {
    display: inline-block;
    position: relative;
    width: 100%;
    height: 100%;
...
`;class No extends HTMLElement{static get observedAttributes(){return["value","trigger-opacity"]}_value="#0078D4";_h=210;_s=100;_v=83;_popover=null;_satArea=null;_satCursor=null;_hueSlider=null;_hueCursor=null;_hexInput=null;_preview=null;_isDraggingSat=!1;_isDraggingHue=!1;constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.bindEvents(),this.hexToHsv(this._value),this.updateUI()}get value(){return this._value}set value(o){if(this._value!==o){if(this._value=o,this.hexToHsv(o),this.updateUI(),this._hexInput)this._hexInput.value=o}}attributeChangedCallback(o,r,t){if(o==="value"&&r!==t)this.value=t;else if(o==="trigger-opacity"&&r!==t)this.updateTriggerOpacity(t)}updateTriggerOpacity(o){if(this.shadowRoot){let r=this.shadowRoot.getElementById("trigger");if(r)r.style.opacity=o}}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
            <style>${xo}</style>
...
(max-width: 1024px) {
    ...
    `};function nr(o,r,t,i,n,e=0,s=!1){let p=e||o.h||1;if(o.type==="widget"){let v=r.widgetId,b={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry",weather:"widget-weather",markdown:"widget-markdown"}[v]||"div",q=(r.text||"").replace(/"/g,"&quot;"),h=r.borderColor&&!t?`border-color: ${r.borderColor} !important;`:"",Z=!t?`border-width: ${r.borderWidth||1}px !important;`:"";return`
        <div class="bookmark-grid__card"
            draggable="${t}"
            data-id="${o.id}"
            data-type="${o.type}"
            data-orig-x="${o.x}" data-orig-y="${o.y}"
            ${!s?`style="--x: ${i.x}; --y: ${i.y}; --w: ${n}; --h: ${p}; ${h} ${Z}"`:""}>
