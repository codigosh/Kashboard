var gr=Object.defineProperty;var yo=(o,t)=>{for(var r in t)gr(o,r,{get:t[r],enumerable:!0,configurable:!0,set:(e)=>t[r]=()=>e})};var K=function(o,t,r,e){var i=arguments.length,a=i<3?t:e===null?e=Object.getOwnPropertyDescriptor(t,r):e,s;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")a=Reflect.decorate(o,t,r,e);else for(var l=o.length-1;l>=0;l--)if(s=o[l])a=(i<3?s(a):i>3?s(t,r,a):s(t,r))||a;return i>3&&a&&Object.defineProperty(t,r,a),a};var Z=(o,t)=>{if(typeof Reflect==="object"&&typeof Reflect.metadata==="function")return Reflect.metadata(o,t)},ko=(o,t)=>()=>(o&&(t=o(o=0)),t);var Mo={};yo(Mo,{socketService:()=>xr});class Qo{socket=null;listeners=[];reconnectTimeout;constructor(){this.connect()}connect(){let o=window.location.protocol==="https:"?"wss:":"ws:",t=window.location.host,r=`${o}//${t}/ws`;this.socket=new WebSocket(r),this.socket.onmessage=(e)=>{try{let i=JSON.parse(e.data);this.notify(i)}catch(i){console.error("[SocketService] Failed to parse message",i)}},this.socket.onclose=()=>{console.warn("[SocketService] WebSocket closed. Reconnecting..."),this.scheduleReconnect()},this.socket.onerror=(e)=>{console.error("[SocketService] WebSocket error",e),this.socket?.close()}}scheduleReconnect(){if(this.reconnectTimeout)clearTimeout(this.reconnectTimeout);this.reconnectTimeout=setTimeout(()=>this.connect(),5000)}subscribe(o){return this.listeners.push(o),()=>{this.listeners=this.listeners.filter((t)=>t!==o)}}notify(o){this.listeners.forEach((t)=>t(o))}}var xr;var Yo=ko(()=>{xr=new Qo});var D={};yo(D,{collisionService:()=>L});var L;var O=ko(()=>{L={isOverlap(o,t){return o.x<t.x+t.w&&o.x+o.w>t.x&&o.y<t.y+t.h&&o.y+o.h>t.y},calculateDropValidity(o,t,r=12){let e=Number(o.x),i=Number(o.y),a=Number(o.w),s=Number(o.h);if(e<1||e+a-1>r||i<1)return{valid:!1,x:e,y:i};let c=t.find((d)=>d.id===o.id)?.type==="section",p={x:e,y:i,w:a,h:s};for(let d of t){if(d.id===o.id)continue;let g=Number(d.x),h=Number(d.y),b=Number(d.w||1),u=Number(d.h||1),_={x:g,y:h,w:b,h:u};if(d.parent_id){let w=t.find((m)=>m.id===d.parent_id);if(w)_.x=Number(w.x)+g-1,_.y=Number(w.y)+h-1;else continue}if(this.isOverlap(p,_)){if(!c&&d.type==="section"){let w=e-Number(d.x)+1,m=i-Number(d.y)+1;if(w<1||w+a-1>Number(d.w||1)||m<1||m+s-1>Number(d.h||1))return{valid:!1,x:e,y:i};let B=t.filter((H)=>H.parent_id===d.id),$=!1;for(let H of B){let No={x:Number(H.x),y:Number(H.y),w:Number(H.w||1),h:Number(H.h||1)},T={x:w,y:m,w:a,h:s};if(this.isOverlap(T,No)){$=!0;break}}if(!$)return{valid:!0,x:e,y:i,targetGroup:d}}return{valid:!1,x:e,y:i}}}return{valid:!0,x:e,y:i}},snapToGrid(o,t,r,e){let i=r+e,a=Math.max(1,Math.floor(o/i)+1),s=r+e,l=Math.max(1,Math.floor(t/s)+1);return{x:a,y:l}},findFirstAvailableSlot(o,t,r,e=12){let i=1;while(!0){for(let a=1;a<=e-o+1;a++){let s={x:a,y:i,w:o,h:t},l=!1;for(let c of r){let{x:p,y:d}=c,g=c.w||1,h=c.h||1;if(c.parent_id){let u=r.find((_)=>_.id===c.parent_id);if(u)p=u.x+c.x-1,d=u.y+c.y-1;else continue}let b={x:p,y:d,w:g,h};if(this.isOverlap(s,b)){l=!0;break}}if(!l)return{x:a,y:i}}if(i++,i>1000)return{x:1,y:1000}}},findAvailableSlot(o,t,r,e){let i=1;while(!0){for(let a=1;a<=e-o+1;a++){let s={x:a,y:i,w:o,h:t},l=!1;for(let c of r)if(this.isOverlap(s,c)){l=!0;break}if(!l)return{x:a,y:i}}if(i++,i>1000)return{x:1,y:1000}}}}});var Go={};yo(Go,{eventBus:()=>so,EVENTS:()=>ao});var ao,Zt,so;var vo=ko(()=>{ao={SHOW_CONFIRMATION:"kashboard:show-confirmation",SHOW_WIDGET_CONFIG:"kashboard:show-widget-config",NOTIFY:"kashboard:notify"};Zt=class Zt extends EventTarget{emit(o,t){this.dispatchEvent(new CustomEvent(o,{detail:t}))}on(o,t){this.addEventListener(o,t)}off(o,t){this.removeEventListener(o,t)}};so=new Zt});class Eo{baseUrl;constructor(){this.baseUrl=window.CSH_CONFIG?.API_BASE_URL||""}async request(o,t){let r=`${this.baseUrl}${o}`;try{let e=await fetch(r,{...t,headers:{"Content-Type":"application/json",...t.headers}});if(!e.ok){let a=await e.json().catch(()=>({}));throw Error(a.error||`HTTP ${e.status}: ${e.statusText}`)}let i=await e.text();return i?JSON.parse(i):{}}catch(e){throw console.error(`[ApiService] Request failed: ${r}`,e),e}}async get(o){return this.request(o,{method:"GET"})}async post(o,t){return this.request(o,{method:"POST",body:JSON.stringify(t)})}async patch(o,t){return this.request(o,{method:"PATCH",body:JSON.stringify(t)})}async put(o,t){return this.request(o,{method:"PUT",body:JSON.stringify(t)})}async delete(o){return this.request(o,{method:"DELETE"})}}var z=new Eo;var F={async getCurrentUser(){return z.get("/api/me")},async updateProfile(o){return z.post("/api/user/update-profile",o)},async updatePreferences(o){return z.post("/api/user/preferences",o)},async changePassword(o){return z.post("/api/user/change-password",o)},async getUsers(){return z.get("/api/users")},async createUser(o){return z.post("/api/users",o)},async adminUpdateUser(o){return z.put("/api/users",o)},async deleteUser(o){return z.delete(`/api/users?id=${o}`)}};var N=[{code:"en",name:"English",flag:"\uD83C\uDDFA\uD83C\uDDF8"},{code:"zh",name:"简体中文",flag:"\uD83C\uDDE8\uD83C\uDDF3"},{code:"hi",name:"हिन्दी",flag:"\uD83C\uDDEE\uD83C\uDDF3"},{code:"es",name:"Español",flag:"\uD83C\uDDEA\uD83C\uDDF8"},{code:"ar",name:"العربية",flag:"\uD83C\uDDF8\uD83C\uDDE6"},{code:"fr",name:"Français",flag:"\uD83C\uDDEB\uD83C\uDDF7"},{code:"bn",name:"Bengali",flag:"\uD83C\uDDE7\uD83C\uDDE9"},{code:"pt",name:"Português",flag:"\uD83C\uDDF5\uD83C\uDDF9"},{code:"ru",name:"Русский",flag:"\uD83C\uDDF7\uD83C\uDDFA"},{code:"de",name:"Deutsch",flag:"\uD83C\uDDE9\uD83C\uDDEA"},{code:"ja",name:"日本語",flag:"\uD83C\uDDEF\uD83C\uDDF5"},{code:"it",name:"Italiano",flag:"\uD83C\uDDEE\uD83C\uDDF9"},{code:"tr",name:"Turkish",flag:"\uD83C\uDDF9\uD83C\uDDF7"},{code:"ko",name:"한국어",flag:"\uD83C\uDDF0\uD83C\uDDF7"},{code:"id",name:"Indonesian",flag:"\uD83C\uDDEE\uD83C\uDDE9"},{code:"pl",name:"Polski",flag:"\uD83C\uDDF5\uD83C\uDDF1"},{code:"ur",name:"Urdu",flag:"\uD83C\uDDF5\uD83C\uDDF0"},{code:"nl",name:"Nederlands",flag:"\uD83C\uDDF3\uD83C\uDDF1"},{code:"fa",name:"Persian",flag:"\uD83C\uDDEE\uD83C\uDDF7"},{code:"el",name:"Greek",flag:"\uD83C\uDDEC\uD83C\uDDF7"}];class U{currentLanguage="en";cache=new Map;listeners=[];static instance;initialized;constructor(){this.initialized=this.init()}async init(){await this.loadLocale("en");let o=localStorage.getItem("csh_lang"),t=navigator.language.split("-")[0],r="en";if(o&&N.find((e)=>e.code===o))r=o;else if(N.find((e)=>e.code===t))r=t;if(r!=="en")await this.loadLocale(r);this.currentLanguage=r,this.notifyListeners()}static getInstance(){if(!U.instance)U.instance=new U;return U.instance}getLocale(){return{...N.find((t)=>t.code===this.currentLanguage)||N[0],translations:this.cache.get(this.currentLanguage)||{}}}getAvailableLocales(){return N}async loadLocale(o){if(this.cache.has(o))return;try{let t=await fetch(`/locales/${o}.json?v=${new Date().getTime()}`);if(!t.ok)throw Error(`Failed to load locale ${o}`);let r=await t.json();this.cache.set(o,r)}catch(t){console.error(t)}}async setLanguage(o){if(N.find((t)=>t.code===o))await this.loadLocale(o),this.currentLanguage=o,localStorage.setItem("csh_lang",o),this.notifyListeners();else console.warn(`[I18n] Language ${o} not supported`)}t(o,t){let r=this.cache.get(this.currentLanguage),e=this.cache.get("en"),i=r?.[o];if(!i&&e)i=e[o];if(!i)return o;if(t)Object.keys(t).forEach((a)=>{i=i.replace(`{${a}}`,t[a])});return i}subscribe(o){return this.listeners.push(o),o(this.getLocale()),()=>{this.listeners=this.listeners.filter((t)=>t!==o)}}notifyListeners(){let o=this.getLocale();this.listeners.forEach((t)=>t(o))}async ensureInitialized(){return this.initialized}}var n=U.getInstance();class Jo{user=null;listeners=[];constructor(){this.loadFromStorage()}loadFromStorage(){let o=localStorage.getItem("csh_user_cache");if(o)try{this.user=JSON.parse(o),this.applyAesthetics(),this.notify()}catch(t){console.error("Failed to parse user cache",t)}}saveToStorage(){if(this.user)localStorage.setItem("csh_user_cache",JSON.stringify(this.user))}subscribe(o){if(this.listeners.push(o),this.user)o(this.user);return()=>{this.listeners=this.listeners.filter((t)=>t!==o)}}notify(){this.listeners.forEach((o)=>o(this.user)),this.saveToStorage()}setUser(o){if(!o)return;let t={grid_columns_pc:9,grid_columns_tablet:4,grid_columns_mobile:2};this.user={...o,preferences:{accent_color:o.accent_color||"blue",language:o.language||"en",theme:o.theme,grid_columns_pc:o.grid_columns_pc||t.grid_columns_pc,grid_columns_tablet:o.grid_columns_tablet||t.grid_columns_tablet,grid_columns_mobile:o.grid_columns_mobile||t.grid_columns_mobile,project_name:o.project_name||"CSH Dashboard"},project_name:o.project_name||"CSH Dashboard"},this.applyAesthetics(),this.notify()}applyAesthetics(){if(!this.user||!this.user.preferences)return;let o=this.user.preferences,t=document.documentElement;if(o.grid_columns_pc)t.style.setProperty("--grid-columns-pc",String(o.grid_columns_pc));if(o.grid_columns_tablet)t.style.setProperty("--grid-columns-tablet",String(o.grid_columns_tablet));if(o.grid_columns_mobile)t.style.setProperty("--grid-columns-mobile",String(o.grid_columns_mobile));if(o.accent_color){let r=this.getAccentHex(o.accent_color);t.style.setProperty("--accent",r)}if(o.theme==="light")t.classList.add("light-theme");else t.classList.remove("light-theme")}getAccentHex(o){if(o.startsWith("#"))return o;return{blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"}[o]||"#0078D4"}async updatePreferences(o){if(!this.user||!this.user.preferences)return;let t={...this.user.preferences};if(this.user.preferences={...this.user.preferences,...o},o.accent_color)this.user.accent_color=o.accent_color;if(o.language)this.user.language=o.language;if(o.project_name)this.user.project_name=o.project_name;if(o.theme)this.user.preferences.theme=o.theme;this.applyAesthetics(),this.notify();try{if(await F.updatePreferences({accent_color:this.user.accent_color,language:this.user.language,theme:this.user.preferences.theme,grid_columns_pc:this.user.preferences.grid_columns_pc,grid_columns_tablet:this.user.preferences.grid_columns_tablet,grid_columns_mobile:this.user.preferences.grid_columns_mobile,project_name:this.user.project_name}),window.notifier)window.notifier.show(n.t("general.success")||"Preferences saved")}catch(r){if(console.error("[UserStore] Failed to sync preferences, rolling back",r),this.user.preferences=t,this.applyAesthetics(),this.notify(),window.notifier)window.notifier.show("Failed to save settings","error")}}async updateProfile(o){if(!this.user)return;try{if(await F.updateProfile(o),this.user={...this.user,...o},this.notify(),window.notifier)window.notifier.show("Profile updated")}catch(t){if(console.error("[UserStore] Update profile failed",t),window.notifier)window.notifier.show("Failed to update profile","error")}}async changePassword(o){try{await F.changePassword(o)}catch(t){throw console.error("[UserStore] Change password failed",t),t}}getUser(){return this.user}async fetchUser(){try{let o=await F.getCurrentUser();this.setUser(o)}catch(o){if(console.error("[UserStore] Error fetching user",o),!this.user){if(window.notifier)window.notifier.show("Session expired or server unreachable","error")}}}}var k=new Jo;var A={async getItems(){return z.get("/api/dashboard")},async updateItem(o){let t={...o};if(o.parent_id===void 0&&"parent_id"in o)t.clear_parent=!0;return z.patch(`/api/dashboard/item/${o.id}`,t)},async createItem(o){return z.post("/api/dashboard/item",o)},async deleteItem(o){return z.delete(`/api/dashboard/item/${o}`)},async checkHealth(o){return z.get(`/api/dashboard/health?url=${encodeURIComponent(o)}`)}};var lo="kashboard-items",wo=[{id:1,type:"bookmark",x:1,y:1,w:1,h:1,content:{label:"Proxmox",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/proxmox.png",iconName:"proxmox"}},{id:2,type:"bookmark",x:2,y:1,w:1,h:1,content:{label:"TrueNAS",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/truenas.png",iconName:"truenas"}},{id:3,type:"bookmark",x:3,y:1,w:1,h:1,content:{label:"Cloudflare",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/cloudflare.png",iconName:"cloudflare"}},{id:4,type:"bookmark",x:1,y:2,w:1,h:1,content:{label:"GitHub",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/github.png",iconName:"github"}},{id:5,type:"bookmark",x:2,y:2,w:1,h:1,content:{label:"VS Code",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/vscode.png",iconName:"vscode"}},{id:6,type:"bookmark",x:3,y:2,w:1,h:1,content:{label:"Documentation",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/docs.png",iconName:"docs"}}];class Co{state={isEditing:!1,items:[...wo],searchQuery:"",isOffline:!1,stats:null};listeners=[];constructor(){this.loadFromLocalStorage(),this.initSocket()}initSocket(){Promise.resolve().then(() => (Yo(),Mo)).then(({socketService:o})=>{o.subscribe((t)=>{this.state.stats={cpu_usage:t.cpu_usage,ram_usage:t.ram_usage,temperature:t.temperature},this.notify()})})}saveToLocalStorage(){try{if(this.state.items.filter((r)=>r.parent_id!==void 0).length>0);let t=JSON.stringify(this.state.items);localStorage.setItem(lo,t)}catch(o){console.error("[DashboardStore] Failed to save to localStorage",o)}}loadFromLocalStorage(){try{let o=localStorage.getItem(lo);if(o){let t=JSON.parse(o);if(Array.isArray(t)&&t.length>0)this.state.items=t}}catch(o){console.error("[DashboardStore] Failed to load from localStorage",o)}}subscribe(o){return this.listeners.push(o),this.ensureItemsIsArray(),o({...this.state,items:[...this.state.items]}),()=>{this.listeners=this.listeners.filter((t)=>t!==o)}}ensureItemsIsArray(){if(!Array.isArray(this.state.items))console.error("[DashboardStore] CRITICAL: items is not an array, resetting to empty array",typeof this.state.items),this.state.items=[]}notify(){this.ensureItemsIsArray();let o={...this.state,items:[...this.state.items]};this.listeners.forEach((t)=>t(o))}setEditMode(o){this.state.isEditing=o,this.notify()}toggleEditMode(){this.setEditMode(!this.state.isEditing)}setSearchQuery(o){this.state.searchQuery=o.toLowerCase().trim(),this.notify()}async fetchItems(){try{try{let o=await A.getItems();if(Array.isArray(o)&&o.length>0){let t=localStorage.getItem(lo);if(t){let r=JSON.parse(t);o.forEach((e)=>{if(e.parent_id===void 0){let i=r.find((a)=>a.id===e.id);if(i&&i.parent_id!==void 0)e.parent_id=i.parent_id}})}this.state.items=o,this.state.isOffline=!1,this.saveToLocalStorage()}else throw Error("Backend returned empty or invalid data")}catch(o){this.state.isOffline=!0;let t=localStorage.getItem(lo);if(t){let r=JSON.parse(t);if(Array.isArray(r)&&r.length>0)this.state.items=r;else this.state.items=[...wo],this.saveToLocalStorage()}else this.state.items=[...wo],this.saveToLocalStorage()}this.ensureItemsIsArray(),this.notify()}catch(o){console.error("[DashboardStore] Failed to fetch dashboard items",o),this.state.items=[]}}async updateItem(o){try{this.ensureItemsIsArray();let t=this.state.items.findIndex((e)=>e.id==o.id);if(t===-1){console.warn("[DashboardStore] Item not found for update:",o.id);return}let r={...this.state.items[t]};this.state.items[t]={...this.state.items[t],...o},this.saveToLocalStorage(),this.notify();try{await A.updateItem(o),this.state.isOffline=!1,this.notify()}catch(e){console.error("[DashboardStore] Failed to sync item update (offline?), keeping local state",e),this.state.isOffline=!0,this.saveToLocalStorage(),this.notify()}}catch(t){console.error("[DashboardStore] Error updating item",t)}}async resizeItem(o,t,r){let e=this.state.items.find((i)=>i.id===o);if(!e)return;if(console.log(`[DashboardStore] Resizing item ${o} to ${t}x${r}`),await this.updateItem({id:o,w:t,h:r}),e.type==="section")await this.reflowChildren(o,t)}async reflowChildren(o,t){Promise.resolve().then(() => (O(),D)).then(async({collisionService:r})=>{let e=this.state.items.filter((a)=>a.parent_id===o).sort((a,s)=>a.y-s.y||a.x-s.x);if(e.length===0)return;console.log(`[DashboardStore] Reflowing ${e.length} children for parent ${o}`);let i=[];for(let a of e){let s=r.findAvailableSlot(a.w,a.h,i,t);if(i.push({x:s.x,y:s.y,w:a.w,h:a.h}),a.x!==s.x||a.y!==s.y)console.log(`[DashboardStore] Reflow moving child ${a.id} to ${s.x},${s.y}`),await this.updateItem({id:a.id,x:s.x,y:s.y})}})}async addItem(o){try{console.log("[DashboardStore] Adding item:",o),this.ensureItemsIsArray();try{let t={...o};if(t.type==="widget"&&!t.url)t.url="";let r=await A.createItem(t);this.state.isOffline=!1,this.state.items.push(r),console.log("[DashboardStore] Item added (Synced), new length:",this.state.items.length),this.saveToLocalStorage(),this.notify()}catch(t){console.error("[DashboardStore] Failed to add item to backend",t)}}catch(t){console.error("[DashboardStore] Error adding item",t)}}async deleteItem(o){try{this.ensureItemsIsArray();let t=this.state.items.findIndex((e)=>e.id==o);if(console.log("[DashboardStore] Deleting item",o,"Found index:",t),t===-1){console.warn("[DashboardStore] Item not found for deletion:",o);return}let r=this.state.items[t];this.state.items.splice(t,1),this.saveToLocalStorage(),this.notify();try{await A.deleteItem(o)}catch(e){console.error("[DashboardStore] Failed to delete item, rolling back",e),this.state.items.push(r),this.saveToLocalStorage(),this.notify()}}catch(t){console.error("[DashboardStore] Error deleting item",t)}}getState(){return this.ensureItemsIsArray(),{...this.state,items:[...this.state.items]}}}var x=new Co;class Zo{interval=null;checkFrequency=300000;start(){if(this.interval)return;setTimeout(()=>this.checkAll(),2000),this.interval=window.setInterval(()=>{this.checkAll()},this.checkFrequency)}stop(){if(this.interval)clearInterval(this.interval),this.interval=null}async checkAll(){let t=x.getState().items.filter((r)=>{if(r.type!=="bookmark")return!1;let e=r.content;if(typeof e==="string")try{e=JSON.parse(e)}catch(i){return!1}return e&&e.statusCheck===!0});for(let r of t)this.checkItem(r)}async checkItem(o){let t=o.content;if(typeof t==="string")try{t=JSON.parse(t)}catch(e){return}let r=t.url;if(!r||r==="#"||r.startsWith("javascript:"))return;try{if((await A.checkHealth(r)).status==="up")this.updateUIStatus(o.id,"up");else this.updateUIStatus(o.id,"down")}catch(e){console.warn(`[StatusService] ${r} health check failed:`,e),this.updateUIStatus(o.id,"down")}}updateUIStatus(o,t){let r=document.querySelector("bookmark-grid");if(!r||!r.shadowRoot)return;let e=r.shadowRoot.querySelector(`.bookmark-grid__card[data-id="${o}"]`);if(!e)return;let i=e.querySelector(".status-indicator");if(!i)return;i.classList.remove("status-pending","status-up","status-down"),i.classList.add(`status-${t}`);let a=t==="up"?"Online":t==="down"?"Offline / Unreachable":"Checking...";i.setAttribute("title",a)}}var P=new Zo;class R{static STORAGE_KEY="kashboard_theme";static CLASS_NAME="dark-mode";static init(){let o=localStorage.getItem(this.STORAGE_KEY);if(o==="dark")this.enableDark();else if(o==="light")this.enableLight();else if(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)this.enableDark();else this.enableLight()}static enableDark(){document.documentElement.classList.add(this.CLASS_NAME),localStorage.setItem(this.STORAGE_KEY,"dark"),this.setCookie(this.STORAGE_KEY,"dark",365)}static enableLight(){document.documentElement.classList.remove(this.CLASS_NAME),localStorage.setItem(this.STORAGE_KEY,"light"),this.setCookie(this.STORAGE_KEY,"light",365)}static toggle(){if(document.documentElement.classList.contains(this.CLASS_NAME))this.enableLight();else this.enableDark()}static isDark(){return document.documentElement.classList.contains(this.CLASS_NAME)}static setCookie(o,t,r){let e="";if(r){let i=new Date;i.setTime(i.getTime()+r*24*60*60*1000),e="; expires="+i.toUTCString()}document.cookie=o+"="+(t||"")+e+"; path=/"}static async sync(){try{let o=await fetch("/api/me");if(o.ok){let t=await o.json();if(t.theme==="dark")this.enableDark();else if(t.theme==="light")this.enableLight()}}catch(o){}}}var Uo=()=>`
    <div class="paper">
        <slot></slot>
    </div>
`;var Oo=`:host {
...
.paper {
    ...
    height: 100%;
}`;class Xo extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            <style>${Oo}</style>
            ${Uo()}
        `}}if(!customElements.get("app-paper"))customElements.define("app-paper",Xo);var Vo=`:host {
...
.avatar__initials {
    user-select: none;
}`;class Io extends HTMLElement{static get observedAttributes(){return["src","alt","initials"]}constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}attributeChangedCallback(o,t,r){if(t!==r)this.render()}render(){let o=this.getAttribute("src"),t=this.getAttribute("initials")||"??",r=this.getAttribute("alt")||"User Avatar";this.shadowRoot.innerHTML=`
            <style>${Wo}</style>
            ${Po({src:o||void 0,initials:t,alt:r})}
        `}}if(!customElements.get("app-avatar"))customElements.define("app-avatar",Io);var So=(o)=>`
                ...
                <div style="display: flex; gap: 16px;">
                    <div style="flex: 1;">
                        ...
                        <select class="settings-content__select" onchange="this.getRootNode().host.savePrefs({language: this.value})">
                            ${n.getAvailableLocales().map((e)=>`<option value="${e.code}" ${o.language===e.code?"selected":""}>${e.flag} ${e.name}</option>`).join("")}
                        </select>
                    </div>
                    <div style="flex: 1;">
                    ...
                    `:`
                        ...
                        ${t.available?`
                             <div style="background: rgba(18, 184, 134, 0.1); border: 1px solid rgba(18, 184, 134, 0.3); padding: 24px; border-radius: var(--radius); width: 100%;">
                                <h3 style="margin: 0 0 12px 0; color: #12b886; font-size: 16px;">${n.t("settings.update_available")}: ${t.latest_version}</h3>
                                ...
                                <app-button variant="primary" id="btn-update-now" style="width: 100%; justify-content: center;" onclick="this.getRootNode().host.performUpdate('${t.asset_url}')">
                                    ${n.t("action.download_install")} ${t.latest_version}
                                </app-button>
                                <p id="update-status" style="margin-top: 12px; font-size: 12px; color: var(--text-dim); display: none;">${n.t("notifier.downloading_secure")}</p>
                            </div>
                        `:`
...
.settings-content__danger-title {
    ...
    align-items: center;
    gap: 8px;
}`;class at extends HTMLElement{prefs;users=[];static get observedAttributes(){return["section"]}constructor(){super();this.attachShadow({mode:"open"}),this.prefs={accent_color:"#0078D4",language:"en",grid_columns_pc:9,grid_columns_tablet:4,grid_columns_mobile:2}}connectedCallback(){if(this.fetchPrefs(),this.getAttribute("section")==="users")this.fetchUsers();this.render()}async fetchPrefs(){let o=k.getUser();if(o&&o.preferences)this.prefs={...o.preferences,project_name:o.project_name||o.preferences.project_name||"Kashboard"},this.render()}async fetchUsers(){try{this.users=await F.getUsers(),this.render()}catch(o){console.error("Failed to fetch users",o)}}attributeChangedCallback(o,t,r){if(o==="section"&&t!==r){if(r==="users")this.fetchUsers();if(r==="about")this.checkForUpdates();this.render()}}async savePrefs(o){if(this.prefs={...this.prefs,...o},o.accent_color)this.applyAccent(o.accent_color);if(o.language)n.setLanguage(o.language);if(o.theme)if(o.theme==="dark")R.enableDark();else R.enableLight();await k.updatePreferences(o),this.render()}applyAccent(o){if(o&&o.startsWith("#")){document.documentElement.style.setProperty("--accent",o);return}let r={blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"}[o]||"#0078D4";document.documentElement.style.setProperty("--accent",r)}updateGridPref(o,t){let r=this.shadowRoot.getElementById(`val-${o}`);if(r)r.textContent=t;let e={grid_columns_pc:"--grid-columns-pc",grid_columns_tablet:"--grid-columns-tablet",grid_columns_mobile:"--grid-columns-mobile"};if(e[o])document.documentElement.style.setProperty(e[o],t)}commitGridPref(o,t){k.updatePreferences({[o]:parseInt(t)})}async updateUsername(o){let t=k.getUser();if(!t)return;if(await k.updateProfile({username:o,avatar_url:this.prefs.avatar_url||t.avatar_url}),window.notifier)window.notifier.show(n.t("notifier.username_updated"))}async updatePassword(){let o=this.shadowRoot.getElementById("current-password")?.value,t=this.shadowRoot.getElementById("new-password")?.value,r=this.shadowRoot.getElementById("confirm-password")?.value;if(!o){if(window.notifier)window.notifier.show(n.t("notifier.password_required"),"error");return}if(t!==r){if(window.notifier)window.notifier.show(n.t("notifier.password_mismatch"),"error");return}if(!t){if(window.notifier)window.notifier.show(n.t("notifier.password_empty"),"error");return}try{if(await k.changePassword({current_password:o,new_password:t}),window.notifier)window.notifier.show(n.t("notifier.password_changed"));this.shadowRoot.getElementById("current-password").value="",this.shadowRoot.getElementById("new-password").value="",this.shadowRoot.getElementById("confirm-password").value=""}catch(e){if(window.notifier)window.notifier.show(n.t("notifier.password_incorrect"),"error")}}async handleAvatarChange(o){let t=o.target.files?.[0];if(!t)return;let r=new FileReader;r.onload=async(e)=>{let i=e.target?.result,a=k.getUser();if(!a)return;if(this.prefs.avatar_url=i,await k.updateProfile({username:a.username,avatar_url:i}),this.render(),window.notifier)window.notifier.show(n.t("notifier.avatar_updated"))},r.readAsDataURL(t)}openAddUserModal(){let o=this.shadowRoot.getElementById("add-user-modal");if(o)o.showModal()}async createUser(){let o=this.shadowRoot.getElementById("new-user-username").value,t=this.shadowRoot.getElementById("new-user-password").value,r=this.shadowRoot.getElementById("new-user-role").value;if(!o||!t){if(window.notifier)window.notifier.show(n.t("notifier.fields_required"),"error");return}try{if(await F.createUser({username:o,password:t,role:r}),window.notifier)window.notifier.show(n.t("notifier.user_created"));let e=this.shadowRoot.getElementById("add-user-modal");if(e)e.close();this.fetchUsers()}catch(e){if(window.notifier)window.notifier.show(n.t("notifier.user_create_error"),"error")}}openEditUserModal(o,t,r){let e=this.shadowRoot.getElementById("edit-user-modal");if(e)this.shadowRoot.getElementById("edit-user-id").value=o.toString(),this.shadowRoot.getElementById("edit-user-username").value=t,this.shadowRoot.getElementById("edit-user-role").value=r,this.shadowRoot.getElementById("edit-user-password").value="",e.showModal()}async updateAdminUser(){let o=parseInt(this.shadowRoot.getElementById("edit-user-id").value),t=this.shadowRoot.getElementById("edit-user-username").value,r=this.shadowRoot.getElementById("edit-user-password").value,e=this.shadowRoot.getElementById("edit-user-role").value;if(!t){if(window.notifier)window.notifier.show("Username required","error");return}try{if(await F.adminUpdateUser({id:o,username:t,role:e,password:r||void 0}),window.notifier)window.notifier.show(n.t("notifier.user_updated"));let i=this.shadowRoot.getElementById("edit-user-modal");if(i)i.close();this.fetchUsers()}catch(i){if(window.notifier)window.notifier.show(n.t("notifier.user_update_error"),"error")}}async deleteUser(o){let t=document.querySelector("confirmation-modal");if(t){if(!await t.confirm(n.t("general.delete"),n.t("notifier.user_delete_confirm")))return}try{if(await F.deleteUser(o),window.notifier)window.notifier.show(n.t("notifier.user_deleted"));this.fetchUsers()}catch(r){if(window.notifier)window.notifier.show(n.t("notifier.user_delete_error"),"error")}}getContent(o){let t=k.getUser()||{username:"Guest",initials:"??",role:"View Only",avatar_url:"",accent_color:"#0078D4",language:"en",preferences:{}};switch(o){case"account":return So(t);case"theme":{let r={blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"},e=Object.keys(r);return ot(this.prefs,r,e)}case"personalization":{let r=[{label:n.t("settings.grid_pc"),key:"grid_columns_pc",min:4,max:12},{label:n.t("settings.grid_tablet"),key:"grid_columns_tablet",min:2,max:6},{label:n.t("settings.grid_mobile"),key:"grid_columns_mobile",min:1,max:3}];return tt(this.prefs,r)}case"advanced":return et();case"users":return rt(this.users);case"about":return it(this.version,this.updateInfo);default:return`<div class="bento-card"><h3>${o}</h3><p class="settings-content__text-dim">${n.t("settings.default_module_desc")}</p></div>`}}version="v0.0.1";updateInfo=null;async checkForUpdates(){try{let o=await fetch("/api/system/update/check");if(o.ok)this.updateInfo=await o.json(),this.version=this.updateInfo.current_version,this.render()}catch(o){console.error("Check update failed",o)}}async performUpdate(o){let t=document.querySelector("confirmation-modal");if(t){if(!await t.confirm(n.t("settings.update_available"),n.t("notifier.update_start_confirm")))return}let r=this.shadowRoot.getElementById("btn-update-now"),e=this.shadowRoot.getElementById("update-status");if(r)r.loading=!0;if(e)e.style.display="block",e.textContent=n.t("notifier.update_downloading");try{let i=await fetch("/api/system/update/perform",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({asset_url:o})});if(i.ok){if(e)e.textContent=n.t("notifier.update_verified");setTimeout(()=>{window.location.reload()},5000)}else{let a=await i.text();if(e)e.style.color="#fa5252",e.textContent=n.t("notifier.update_failed")+a;if(r)r.loading=!1}}catch(i){if(console.error("Update failed",i),e)e.style.color="#fa5252",e.textContent=n.t("notifier.update_error");if(r)r.loading=!1}}downloadBackup(){window.location.href="/api/system/backup"}async restoreBackup(o){if(!o)return;let t=document.querySelector("confirmation-modal");if(t){if(!await t.confirm(n.t("general.restore"),n.t("notifier.restore_confirm")))return}let r=new FormData;r.append("backup_file",o);try{if((await fetch("/api/system/restore",{method:"POST",body:r})).ok){if(window.notifier)window.notifier.show(n.t("notifier.restore_success"));setTimeout(()=>window.location.reload(),2000)}else if(window.notifier)window.notifier.show(n.t("notifier.restore_failed"),"error")}catch(e){if(console.error("Restore error",e),window.notifier)window.notifier.show(n.t("notifier.restore_failed"),"error")}}openResetModal(){let o=this.shadowRoot.getElementById("reset-confirm-modal"),t=this.shadowRoot.getElementById("reset-confirm-input");if(o){if(t)t.value="";o.showModal()}}async executeFactoryReset(){let o=this.shadowRoot.getElementById("reset-confirm-input");if(!o||o.value.trim()!=="delete"){if(window.notifier)window.notifier.show(n.t("notifier.reset_confirm_text"),"error");o.focus();return}let t=this.shadowRoot.getElementById("btn-reset-confirm");try{if(t)t.disabled=!0,t.textContent=n.t("settings.restoring")||"Restoring...";if((await fetch("/api/system/reset",{method:"POST"})).ok){let e=document.createElement("div");Object.assign(e.style,{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",backgroundColor:"rgba(0,0,0,0.9)",zIndex:"9999",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",color:"white",fontFamily:"var(--font-main, sans-serif)"}),e.innerHTML=`
                ...
                `,document.body.appendChild(e);let i=0,a=async()=>{i++;try{if((await fetch("/",{method:"HEAD",cache:"no-store"})).ok){window.location.href="/setup";return}}catch(s){}if(i<60)setTimeout(a,1000);else window.location.href="/setup"};setTimeout(a,2000)}else if(window.notifier)window.notifier.show(n.t("notifier.reset_failed"),"error")}catch(r){if(console.error("Reset error",r),window.notifier)window.notifier.show(n.t("notifier.reset_error"),"error")}}render(){this.shadowRoot.innerHTML=`
            <style>${nt}</style>
            <div class="fade-in">
                ${this.getContent(this.getAttribute("section")||"account")}
            </div>
        `,this.shadowRoot.querySelectorAll(".settings-content__checkbox").forEach((o)=>{o.addEventListener("click",()=>o.classList.toggle("settings-content__checkbox--checked"))})}}if(!customElements.get("settings-content"))customElements.define("settings-content",at);var st=({user:o,isOpen:t,selectedSection:r})=>`
        ...
        <div class="right-drawer__header">
            ...
            <div class="right-drawer__user-info">
                ...
                ${o.role?.toLowerCase()==="admin"||o.role?.toLowerCase()==="administrator"?`<span class="right-drawer__role">
                    ${(()=>{let e=(o.role||"").toLowerCase();if(e==="admin"||e==="administrator")return n.t("settings.role_admin");if(e==="user")return n.t("settings.role_user");return o.role||n.t("settings.default_role")})()}
                </span>`:""}
            </div>
        </div>
    ...
    <div class="top-bar">
        ...
        <div class="top-bar__actions">
            ...
            <div id="search-wrapper" class="search-wrapper ${r?"search-wrapper--active":""}">
                ...
                <div id="search-clear" class="search-clear" style="display: ${a?"flex":"none"};">×</div>
...
}`;class bt extends HTMLElement{dropdownOpen;constructor(){super();this.attachShadow({mode:"open"}),this.dropdownOpen=!1}connectedCallback(){this.render(),this.setupListeners()}toggleDropdown(o){this.dropdownOpen=typeof o==="boolean"?o:!this.dropdownOpen,this.render()}setupListeners(){this.shadowRoot.addEventListener("click",(o)=>{let t=o.target,r=t.closest(".header__btn-changelog");if(r)console.log("Changelog closed"),r.style.display="none";if(t.closest("#profile-trigger"))o.stopPropagation(),this.toggleDropdown()}),window.addEventListener("click",()=>{if(this.dropdownOpen)this.toggleDropdown(!1)})}render(){let o=this.getAttribute("title")||"Task";this.shadowRoot.innerHTML=`
            <style>${ht}</style>
            ${xt({title:o,dropdownOpen:this.dropdownOpen})}
        `}}if(!customElements.get("app-header"))customElements.define("app-header",bt);var vt=({bookmarks:o,isEditing:t,isSearching:r,isTouchDevice:e})=>{let i=Array.isArray(o)?o:[],a=(c)=>i.filter((p)=>p.parent_id===c);return`
    ${(r||e?i:i.filter((c)=>!c.parent_id)).map((c)=>{let p={};try{p=typeof c.content==="string"?JSON.parse(c.content):c.content}catch(g){console.error("Failed to parse content for item",c.id,g)}if(c.type==="section"){let g=a(c.id);return`
            <div class="bookmark-grid__section"
               ...
               `:""}
            </div>`}return _t(c,p,t)}).join("")}

    <div id="ghost-element" class="bookmark-grid__ghost" style="display: none;"></div>
`};function _t(o,t,r){if(o.type==="widget"){let l=t.widgetId,p={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry"}[l]||"div",g=(t.text||"").replace(/"/g,"&quot;");return`
         ...
         `}let e=t.icon||"",a=e.startsWith("http")||e.startsWith("/")?`<img src="${e}" alt="${t.label}" class="bookmark-grid__icon-img" draggable="false" />`:e||'<svg class="bookmark-grid__icon-svg" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>';return`
    ...
    `}function yr(o,t,r=!1){return o.map((e)=>{let i={};try{i=typeof e.content==="string"?JSON.parse(e.content):e.content}catch(a){console.error("Failed to parse content for item (nested)",e.id,a)}return _t(e,i,t)}).join("")}O();class ft extends HTMLElement{timer;timeEl=null;dateEl=null;_unsubscribe=null;_unsubscribeI18n;constructor(){super();this.attachShadow({mode:"open"})}isEditing=!1;configMode=!1;_config={timezone:"local",hour12:!1,showDate:!0};_itemId=0;static get observedAttributes(){return["item-id","content","mode"]}attributeChangedCallback(o,t,r){if(o==="item-id")this._itemId=parseInt(r);if(o==="content")try{let e=typeof r==="string"?JSON.parse(r):r;if(e&&typeof e==="object")this._config={...this._config,...e},this.updateTime()}catch(e){}}connectedCallback(){this.render(),this.updateTime(),this.timer=setInterval(()=>{this.updateTime()},1000),this._unsubscribe=x.subscribe((o)=>{if(this.isEditing!==o.isEditing)this.isEditing=o.isEditing,this.render();if(this._itemId){let t=o.items.find((r)=>r.id===this._itemId);if(t&&t.content)try{let r=typeof t.content==="string"?JSON.parse(t.content):t.content;if(r.widgetId==="clock")this._config={...this._config,...r},this.updateTime()}catch(r){}}}),this._unsubscribeI18n=n.subscribe(()=>{this.updateTime()})}disconnectedCallback(){if(this._unsubscribe)this._unsubscribe();if(this._unsubscribeI18n)this._unsubscribeI18n();if(this.timer)clearInterval(this.timer)}updateTime(){if(!this.timeEl||!this.dateEl)return;let o=new Date,t={hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:this._config.hour12},r=void 0;if(this._config.timezone&&this._config.timezone!=="local")r=this._config.timezone;let e=n.getLocale().code;try{let s=new Intl.DateTimeFormat(e,{...t,timeZone:r}).formatToParts(o).map((l)=>{if(l.type==="dayPeriod")return`<span class="ampm">${l.value.toUpperCase().replace(/\./g,"").trim()}</span>`;return l.value}).join("");this.timeEl.innerHTML=s}catch(i){this.timeEl.textContent=o.toLocaleTimeString()}if(this._config.showDate){let i={weekday:"long",day:"numeric",month:"long",timeZone:r};this.dateEl.textContent=o.toLocaleDateString(e,i),this.dateEl.style.display="block"}else this.dateEl.style.display="none"}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
            ...
            <div class="time">--:--:--</div>
            <div class="date">-- --</div>
        `,this.timeEl=this.shadowRoot.querySelector(".time"),this.dateEl=this.shadowRoot.querySelector(".date")}}customElements.define("widget-clock",ft);var co=globalThis,po=co.ShadowRoot&&(co.ShadyCSS===void 0||co.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$o=Symbol(),ut=new WeakMap;class go{constructor(o,t,r){if(this._$cssResult$=!0,r!==$o)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this.t=t}get styleSheet(){let o=this.o,t=this.t;if(po&&o===void 0){let r=t!==void 0&&t.length===1;r&&(o=ut.get(t)),o===void 0&&((this.o=o=new CSSStyleSheet).replaceSync(this.cssText),r&&ut.set(t,o))}return o}toString(){return this.cssText}}var mt=(o)=>new go(typeof o=="string"?o:o+"",void 0,$o),zo=(o,...t)=>{let r=o.length===1?o[0]:t.reduce((e,i,a)=>e+((s)=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+o[a+1],o[0]);return new go(r,o,$o)},yt=(o,t)=>{if(po)o.adoptedStyleSheets=t.map((r)=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(let r of t){let e=document.createElement("style"),i=co.litNonce;i!==void 0&&e.setAttribute("nonce",i),e.textContent=r.cssText,o.appendChild(e)}},jo=po?(o)=>o:(o)=>o instanceof CSSStyleSheet?((t)=>{let r="";for(let e of t.cssRules)r+=e.cssText;return mt(r)})(o):o;var{is:kr,defineProperty:wr,getOwnPropertyDescriptor:$r,getOwnPropertyNames:zr,getOwnPropertySymbols:jr,getPrototypeOf:Tr}=Object,xo=globalThis,kt=xo.trustedTypes,Hr=kt?kt.emptyScript:"",Fr=xo.reactiveElementPolyfillSupport,W=(o,t)=>o,I={toAttribute(o,t){switch(t){case Boolean:o=o?Hr:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,t){let r=o;switch(t){case Boolean:r=o!==null;break;case Number:r=o===null?null:Number(o);break;case Object:case Array:try{r=JSON.parse(o)}catch(e){r=null}}return r}},ho=(o,t)=>!kr(o,t),wt={attribute:!0,type:String,converter:I,reflect:!1,useDefault:!1,hasChanged:ho};Symbol.metadata??=Symbol("metadata"),xo.litPropertyMetadata??=new WeakMap;class G extends HTMLElement{static addInitializer(o){this._$Ei(),(this.l??=[]).push(o)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(o,t=wt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(o)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(o,t),!t.noAccessor){let r=Symbol(),e=this.getPropertyDescriptor(o,r,t);e!==void 0&&wr(this.prototype,o,e)}}static getPropertyDescriptor(o,t,r){let{get:e,set:i}=$r(this.prototype,o)??{get(){return this[t]},set(a){this[t]=a}};return{get:e,set(a){let s=e?.call(this);i?.call(this,a),this.requestUpdate(o,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??wt}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;let o=Tr(this);o.finalize(),o.l!==void 0&&(this.l=[...o.l]),this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){let t=this.properties,r=[...zr(t),...jr(t)];for(let e of r)this.createProperty(e,t[e])}let o=this[Symbol.metadata];if(o!==null){let t=litPropertyMetadata.get(o);if(t!==void 0)for(let[r,e]of t)this.elementProperties.set(r,e)}this._$Eh=new Map;for(let[t,r]of this.elementProperties){let e=this._$Eu(t,r);e!==void 0&&this._$Eh.set(e,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(o){let t=[];if(Array.isArray(o)){let r=new Set(o.flat(1/0).reverse());for(let e of r)t.unshift(jo(e))}else o!==void 0&&t.push(jo(o));return t}static _$Eu(o,t){let r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof o=="string"?o.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((o)=>this.enableUpdating=o),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((o)=>o(this))}addController(o){(this._$EO??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected&&o.hostConnected?.()}removeController(o){this._$EO?.delete(o)}_$E_(){let o=new Map,t=this.constructor.elementProperties;for(let r of t.keys())this.hasOwnProperty(r)&&(o.set(r,this[r]),delete this[r]);o.size>0&&(this._$Ep=o)}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return yt(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((o)=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this._$EO?.forEach((o)=>o.hostDisconnected?.())}attributeChangedCallback(o,t,r){this._$AK(o,r)}_$ET(o,t){let r=this.constructor.elementProperties.get(o),e=this.constructor._$Eu(o,r);if(e!==void 0&&r.reflect===!0){let i=(r.converter?.toAttribute!==void 0?r.converter:I).toAttribute(t,r.type);this._$Em=o,i==null?this.removeAttribute(e):this.setAttribute(e,i),this._$Em=null}}_$AK(o,t){let r=this.constructor,e=r._$Eh.get(o);if(e!==void 0&&this._$Em!==e){let i=r.getPropertyOptions(e),a=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:I;this._$Em=e;let s=a.fromAttribute(t,i.type);this[e]=s??this._$Ej?.get(e)??s,this._$Em=null}}requestUpdate(o,t,r,e=!1,i){if(o!==void 0){let a=this.constructor;if(e===!1&&(i=this[o]),r??=a.getPropertyOptions(o),!((r.hasChanged??ho)(i,t)||r.useDefault&&r.reflect&&i===this._$Ej?.get(o)&&!this.hasAttribute(a._$Eu(o,r))))return;this.C(o,t,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(o,t,{useDefault:r,reflect:e,wrapped:i},a){r&&!(this._$Ej??=new Map).has(o)&&(this._$Ej.set(o,a??t??this[o]),i!==!0||a!==void 0)||(this._$AL.has(o)||(this.hasUpdated||r||(t=void 0),this._$AL.set(o,t)),e===!0&&this._$Em!==o&&(this._$Eq??=new Set).add(o))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let o=this.scheduleUpdate();return o!=null&&await o,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,i]of this._$Ep)this[e]=i;this._$Ep=void 0}let r=this.constructor.elementProperties;if(r.size>0)for(let[e,i]of r){let{wrapped:a}=i,s=this[e];a!==!0||this._$AL.has(e)||s===void 0||this.C(e,void 0,i,s)}}let o=!1,t=this._$AL;try{o=this.shouldUpdate(t),o?(this.willUpdate(t),this._$EO?.forEach((r)=>r.hostUpdate?.()),this.update(t)):this._$EM()}catch(r){throw o=!1,this._$EM(),r}o&&this._$AE(t)}willUpdate(o){}_$AE(o){this._$EO?.forEach((t)=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(o)),this.updated(o)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(o){return!0}update(o){this._$Eq&&=this._$Eq.forEach((t)=>this._$ET(t,this[t])),this._$EM()}updated(o){}firstUpdated(o){}}G.elementStyles=[],G.shadowRootOptions={mode:"open"},G[W("elementProperties")]=new Map,G[W("finalized")]=new Map,Fr?.({ReactiveElement:G}),(xo.reactiveElementVersions??=[]).push("2.1.2");var To=globalThis,$t=(o)=>o,bo=To.trustedTypes,zt=bo?bo.createPolicy("lit-html",{createHTML:(o)=>o}):void 0;var q=`lit$${Math.random().toFixed(9).slice(2)}$`,Bt="?"+q,Lr=`<${Bt}>`,Q=document,oo=()=>Q.createComment(""),to=(o)=>o===null||typeof o!="object"&&typeof o!="function",Ho=Array.isArray,Br=(o)=>Ho(o)||typeof o?.[Symbol.iterator]=="function";var S=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,jt=/-->/g,Tt=/>/g,E=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ht=/'/g,Ft=/"/g,At=/^(?:script|style|textarea|title)$/i,Fo=(o)=>(t,...r)=>({_$litType$:o,strings:t,values:r}),v=Fo(1),Se=Fo(2),oi=Fo(3),M=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Lt=new WeakMap,J=Q.createTreeWalker(Q,129);function Gt(o,t){if(!Ho(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return zt!==void 0?zt.createHTML(t):t}var Ar=(o,t)=>{let r=o.length-1,e=[],i,a=t===2?"<svg>":t===3?"<math>":"",s=S;for(let l=0;l<r;l++){let c=o[l],p,d,g=-1,h=0;for(;h<c.length&&(s.lastIndex=h,d=s.exec(c),d!==null);)h=s.lastIndex,s===S?d[1]==="!--"?s=jt:d[1]!==void 0?s=Tt:d[2]!==void 0?(At.test(d[2])&&(i=RegExp("</"+d[2],"g")),s=E):d[3]!==void 0&&(s=E):s===E?d[0]===">"?(s=i??S,g=-1):d[1]===void 0?g=-2:(g=s.lastIndex-d[2].length,p=d[1],s=d[3]===void 0?E:d[3]==='"'?Ft:Ht):s===Ft||s===Ht?s=E:s===jt||s===Tt?s=S:(s=E,i=void 0);let b=s===E&&o[l+1].startsWith("/>")?" ":"";a+=s===S?c+Lr:g>=0?(e.push(p),c.slice(0,g)+"$lit$"+c.slice(g)+q+b):c+q+(g===-2?l:b)}return[Gt(o,a+(o[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),e]};class ro{constructor({strings:o,_$litType$:t},r){let e;this.parts=[];let i=0,a=0,s=o.length-1,l=this.parts,[c,p]=Ar(o,t);if(this.el=ro.createElement(c,r),J.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(e=J.nextNode())!==null&&l.length<s;){if(e.nodeType===1){if(e.hasAttributes())for(let d of e.getAttributeNames())if(d.endsWith("$lit$")){let g=p[a++],h=e.getAttribute(d).split(q),b=/([.?@])?(.*)/.exec(g);l.push({type:1,index:i,name:b[2],strings:h,ctor:b[1]==="."?Kt:b[1]==="?"?Nt:b[1]==="@"?Rt:io}),e.removeAttribute(d)}else d.startsWith(q)&&(l.push({type:6,index:i}),e.removeAttribute(d));if(At.test(e.tagName)){let d=e.textContent.split(q),g=d.length-1;if(g>0){e.textContent=bo?bo.emptyScript:"";for(let h=0;h<g;h++)e.append(d[h],oo()),J.nextNode(),l.push({type:2,index:++i});e.append(d[g],oo())}}}else if(e.nodeType===8)if(e.data===Bt)l.push({type:2,index:i});else{let d=-1;for(;(d=e.data.indexOf(q,d+1))!==-1;)l.push({type:7,index:i}),d+=q.length-1}i++}}static createElement(o,t){let r=Q.createElement("template");return r.innerHTML=o,r}}function X(o,t,r=o,e){if(t===M)return t;let i=e!==void 0?r._$Co?.[e]:r._$Cl,a=to(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(o),i._$AT(o,r,e)),e!==void 0?(r._$Co??=[])[e]=i:r._$Cl=i),i!==void 0&&(t=X(o,i._$AS(o,t.values),i,e)),t}class qt{constructor(o,t){this._$AV=[],this._$AN=void 0,this._$AD=o,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(o){let{el:{content:t},parts:r}=this._$AD,e=(o?.creationScope??Q).importNode(t,!0);J.currentNode=e;let i=J.nextNode(),a=0,s=0,l=r[0];for(;l!==void 0;){if(a===l.index){let c;l.type===2?c=new eo(i,i.nextSibling,this,o):l.type===1?c=new l.ctor(i,l.name,l.strings,this,o):l.type===6&&(c=new Et(i,this,o)),this._$AV.push(c),l=r[++s]}a!==l?.index&&(i=J.nextNode(),a++)}return J.currentNode=Q,e}p(o){let t=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(o,r,t),t+=r.strings.length-2):r._$AI(o[t])),t++}}class eo{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(o,t,r,e){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=o,this._$AB=t,this._$AM=r,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let o=this._$AA.parentNode,t=this._$AM;return t!==void 0&&o?.nodeType===11&&(o=t.parentNode),o}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(o,t=this){o=X(this,o,t),to(o)?o===y||o==null||o===""?(this._$AH!==y&&this._$AR(),this._$AH=y):o!==this._$AH&&o!==M&&this._(o):o._$litType$!==void 0?this.$(o):o.nodeType!==void 0?this.T(o):Br(o)?this.k(o):this._(o)}O(o){return this._$AA.parentNode.insertBefore(o,this._$AB)}T(o){this._$AH!==o&&(this._$AR(),this._$AH=this.O(o))}_(o){this._$AH!==y&&to(this._$AH)?this._$AA.nextSibling.data=o:this.T(Q.createTextNode(o)),this._$AH=o}$(o){let{values:t,_$litType$:r}=o,e=typeof r=="number"?this._$AC(o):(r.el===void 0&&(r.el=ro.createElement(Gt(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===e)this._$AH.p(t);else{let i=new qt(e,this),a=i.u(this.options);i.p(t),this.T(a),this._$AH=i}}_$AC(o){let t=Lt.get(o.strings);return t===void 0&&Lt.set(o.strings,t=new ro(o)),t}k(o){Ho(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,r,e=0;for(let i of o)e===t.length?t.push(r=new eo(this.O(oo()),this.O(oo()),this,this.options)):r=t[e],r._$AI(i),e++;e<t.length&&(this._$AR(r&&r._$AB.nextSibling,e),t.length=e)}_$AR(o=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);o!==this._$AB;){let r=$t(o).nextSibling;$t(o).remove(),o=r}}setConnected(o){this._$AM===void 0&&(this._$Cv=o,this._$AP?.(o))}}class io{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(o,t,r,e,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=o,this.name=t,this._$AM=e,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=y}_$AI(o,t=this,r,e){let i=this.strings,a=!1;if(i===void 0)o=X(this,o,t,0),a=!to(o)||o!==this._$AH&&o!==M,a&&(this._$AH=o);else{let s=o,l,c;for(o=i[0],l=0;l<i.length-1;l++)c=X(this,s[r+l],t,l),c===M&&(c=this._$AH[l]),a||=!to(c)||c!==this._$AH[l],c===y?o=y:o!==y&&(o+=(c??"")+i[l+1]),this._$AH[l]=c}a&&!e&&this.j(o)}j(o){o===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,o??"")}}class Kt extends io{constructor(){super(...arguments),this.type=3}j(o){this.element[this.name]=o===y?void 0:o}}class Nt extends io{constructor(){super(...arguments),this.type=4}j(o){this.element.toggleAttribute(this.name,!!o&&o!==y)}}class Rt extends io{constructor(o,t,r,e,i){super(o,t,r,e,i),this.type=5}_$AI(o,t=this){if((o=X(this,o,t,0)??y)===M)return;let r=this._$AH,e=o===y&&r!==y||o.capture!==r.capture||o.once!==r.once||o.passive!==r.passive,i=o!==y&&(r===y||e);e&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,o),this._$AH=o}handleEvent(o){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,o):this._$AH.handleEvent(o)}}class Et{constructor(o,t,r){this.element=o,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(o){X(this,o)}}var Gr=To.litHtmlPolyfillSupport;Gr?.(ro,eo),(To.litHtmlVersions??=[]).push("3.3.2");var Jt=(o,t,r)=>{let e=r?.renderBefore??t,i=e._$litPart$;if(i===void 0){let a=r?.renderBefore??null;e._$litPart$=i=new eo(t.insertBefore(oo(),a),a,void 0,r??{})}return i._$AI(o),i};var Lo=globalThis;class Y extends G{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let o=super.createRenderRoot();return this.renderOptions.renderBefore??=o.firstChild,o}update(o){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(o),this._$Do=Jt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}}Y._$litElement$=!0,Y.finalized=!0,Lo.litElementHydrateSupport?.({LitElement:Y});var qr=Lo.litElementPolyfillSupport;qr?.({LitElement:Y});(Lo.litElementVersions??=[]).push("4.2.2");var Qt=(o)=>(t,r)=>{r!==void 0?r.addInitializer(()=>{customElements.define(o,t)}):customElements.define(o,t)};var Kr={attribute:!0,type:String,converter:I,reflect:!1,hasChanged:ho},Nr=(o=Kr,t,r)=>{let{kind:e,metadata:i}=r,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),e==="setter"&&((o=Object.create(o)).wrapped=!0),a.set(r.name,o),e==="accessor"){let{name:s}=r;return{set(l){let c=t.get.call(this);t.set.call(this,l),this.requestUpdate(s,c,o,!0,l)},init(l){return l!==void 0&&this.C(s,void 0,o,l),l}}}if(e==="setter"){let{name:s}=r;return function(l){let c=this[s];t.call(this,l),this.requestUpdate(s,c,o,!0,l)}}throw Error("Unsupported decorator location: "+e)};function no(o){return(t,r)=>typeof r=="object"?Nr(o,t,r):((e,i,a)=>{let s=i.hasOwnProperty(a);return i.constructor.createProperty(a,e),s?Object.getOwnPropertyDescriptor(i,a):void 0})(o,t,r)}function Bo(o){return no({...o,state:!0,attribute:!1})}var C=(o,t,r)=>(r.configurable=!0,r.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(o,t,r),r);function Mt(o,t){return(r,e,i)=>{let a=(s)=>s.renderRoot?.querySelector(o)??null;if(t){let{get:s,set:l}=typeof e=="object"?r:i??(()=>{let c=Symbol();return{get(){return this[c]},set(p){this[c]=p}}})();return C(r,e,{get(){let c=s.call(this);return c===void 0&&(c=a(this),(c!==null||this.hasUpdated)&&l.call(this,c)),c}})}return C(r,e,{get(){return a(this)}})}}var f={bold:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 12a4 4 0 0 0 0-8H6v8"/><path d="M15 20a4 4 0 0 0 0-8H6v8Z"/></svg>`,italic:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>`,underline:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4v6a6 6 0 0 0 12 0V4"/><line x1="4" y1="20" x2="20" y2="20"/></svg>`,strike:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4H9a3 3 0 0 0-2.83 4"/><path d="M14 12a4 4 0 0 1 0 8H6"/><line x1="4" y1="12" x2="20" y2="12"/></svg>`,h1:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h8"/><path d="M4 18V6"/><path d="M12 18V6"/><path d="m17 12 3-2v8"/></svg>`,h2:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h8"/><path d="M4 18V6"/><path d="M12 18V6"/><path d="M21 18h-4c0-4 4-3 4-6 0-1.5-2-2.5-4-1"/></svg>`,list:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>`,listOrdered:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"/></svg>`,checklist:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="2"/><path d="m9 12 2 2 4-4"/></svg>`,link:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`,image:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>`,color:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16"/><path d="m6 16 6-12 6 12"/><path d="M8 12h8"/></svg>`,undo:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7v6h6"/><path d="M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13"/></svg>`,redo:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 7v6h-6"/><path d="M3 17a9 9 0 0 1 9-9 9 9 0 0 1 6 2.3L21 13"/></svg>`,alignLeft:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="15" y1="12" x2="3" y2="12"/><line x1="17" y1="18" x2="3" y2="18"/></svg>`,alignCenter:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="17" y1="12" x2="7" y2="12"/><line x1="19" y1="18" x2="5" y2="18"/></svg>`,alignRight:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="12" x2="9" y2="12"/><line x1="21" y1="18" x2="7" y2="18"/></svg>`,code:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>`,clear:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/></svg>`,edit:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>`,save:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>`};class Ao extends Y{constructor(){super(...arguments);this.itemId=0;this.content="";this.isInternalEditing=!1;this.isDashboardEditing=!1}_unsubscribe;static styles=zo`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `;connectedCallback(){super.connectedCallback(),this._unsubscribe=x.subscribe((t)=>{let r=this.isDashboardEditing;if(this.isDashboardEditing=t.isEditing||!1,r!==this.isDashboardEditing)if(this.isDashboardEditing)this.isInternalEditing=!1,this.requestUpdate();else this.loadFromStore()});let o=x.getState();this.isDashboardEditing=o.isEditing||!1,this.loadFromStore()}disconnectedCallback(){if(super.disconnectedCallback(),this._unsubscribe)this._unsubscribe()}updated(o){if(o.has("content")&&!this.isInternalEditing&&this.editorElement){if(this.editorElement.innerHTML!==this.content)this.editorElement.innerHTML=this.content||""}}loadFromStore(){if(!this.itemId)return;let t=x.getState().items.find((r)=>r.id===this.itemId);if(t)this.parseAndSetContent(t.content)}parseAndSetContent(o){try{let t=o;if(typeof o==="string")try{let r=JSON.parse(o);if(r&&typeof r==="object")t=r.text||""}catch(r){}else if(typeof o==="object")t=o.text||"";this.content=t||""}catch(t){this.content=""}}exec(o,t){if(document.execCommand(o,!1,t),this.editorElement)this.editorElement.focus()}saveContent(){try{let o=this.shadowRoot?.querySelector(".editor")||this.shadowRoot?.querySelector("[contenteditable]");if(!o)throw Error("Critical: Editor div missing");let t=o.innerHTML;this.content=t,this.isInternalEditing=!1,this.requestUpdate(),setTimeout(()=>{if(this.itemId){let r=x.getState().items.find((a)=>a.id===this.itemId),e={};try{e=typeof r?.content==="string"?JSON.parse(r.content):r?.content||{}}catch(a){console.warn("Failed to parse existing content",a)}let i={...e,text:t};x.updateItem({id:this.itemId,content:JSON.stringify(i)}).catch((a)=>console.error("[Store Update Failed]",a))}},0)}catch(o){console.error("[Notepad Save Error]",o),alert(n.t("widget.notepad.error.save")+o)}}startEditing(){if(this.isDashboardEditing)return;this.isInternalEditing=!0,setTimeout(()=>{if(this.editorElement){if(this.editorElement.focus(),this.editorElement.innerHTML!==this.content)this.editorElement.innerHTML=this.content||""}},0)}handleColor(o){let t=o.target;this.exec("foreColor",t.value)}handleToolbarWheel(o){o.preventDefault();let t=o.currentTarget;t.scrollLeft+=o.deltaY}insertChecklist(){let o="chk-"+Math.random().toString(36).substr(2,9),t=`<div style="display:flex; align-items:center; margin: 4px 0;"><input type="checkbox" id="${o}" style="margin-right:8px;"><label for="${o}">${n.t("widget.notepad.prompt.new_item")}</label></div>`;this.exec("insertHTML",t)}insertCode(){let t=`<pre style="background:rgba(0,0,0,0.3); padding:8px; border-radius:4px; font-family:monospace; margin:8px 0;"><code>${n.t("widget.notepad.prompt.code_block")}</code></pre><p><br></p>`;this.exec("insertHTML",t)}render(){try{if(!this.isInternalEditing)return v`
                ...
                <div class="container">
                    <div class="toolbar" @wheel="${this.handleToolbarWheel}" title="${n.t("widget.notepad.tool.scroll_hint")}">
                        <!-- History Group -->
                        <div class="group">
                             <button @click="${(o)=>{o.preventDefault(),this.exec("undo")}}" title="${n.t("widget.notepad.tool.undo")}">${f.undo}</button>
                             <button @click="${(o)=>{o.preventDefault(),this.exec("redo")}}" title="${n.t("widget.notepad.tool.redo")}">${f.redo}</button>
                        </div>
                        
                        <!-- Text Group -->
                        <div class="group">
                            <button @click="${(o)=>{o.preventDefault(),this.exec("formatBlock","H1")}}" title="${n.t("widget.notepad.tool.h1")}">${f.h1}</button>
                            <button @click="${(o)=>{o.preventDefault(),this.exec("formatBlock","H2")}}" title="${n.t("widget.notepad.tool.h2")}">${f.h2}</button>
                            <button @click="${(o)=>{o.preventDefault(),this.exec("bold")}}" title="${n.t("widget.notepad.tool.bold")}">${f.bold}</button>
                            <button @click="${(o)=>{o.preventDefault(),this.exec("italic")}}" title="${n.t("widget.notepad.tool.italic")}">${f.italic}</button>
                            
                            <!-- Color Picker -->
                            <div class="color-wrapper">
                                <button title="${n.t("widget.notepad.tool.color")}">${f.color}</button>
                        ...
                        <!-- Paragraph Group -->
                        <div class="group">
                             <button @click="${(o)=>{o.preventDefault(),this.exec("justifyLeft")}}" title="${n.t("widget.notepad.tool.align_left")}">${f.alignLeft}</button>
                             <button @click="${(o)=>{o.preventDefault(),this.exec("justifyCenter")}}" title="${n.t("widget.notepad.tool.align_center")}">${f.alignCenter}</button>
                             <button @click="${(o)=>{o.preventDefault(),this.exec("justifyRight")}}" title="${n.t("widget.notepad.tool.align_right")}">${f.alignRight}</button>
                        </div>
                        
                        <div class="group">
                            <button @click="${(o)=>{o.preventDefault(),this.insertChecklist()}}" title="${n.t("widget.notepad.tool.checklist")}">${f.checklist}</button>
                            <button @click="${(o)=>{o.preventDefault(),this.exec("insertUnorderedList")}}" title="${n.t("widget.notepad.tool.list_bullet")}">${f.list}</button>
                            <button @click="${(o)=>{o.preventDefault(),this.exec("insertOrderedList")}}" title="${n.t("widget.notepad.tool.list_ordered")}">${f.listOrdered}</button>
                        </div>

                        <!-- Insert Group -->
                        <div class="group">
                            <button @click="${(o)=>{o.preventDefault(),this.insertCode()}}" title="${n.t("widget.notepad.tool.code")}">${f.code}</button>
                            <button @click="${(o)=>{o.preventDefault();let t=prompt(n.t("widget.notepad.prompt.url"));if(t)this.exec("createLink",t)}}" title="${n.t("widget.notepad.tool.link")}">${f.link}</button>
                            <button @click="${(o)=>{o.preventDefault();let t=prompt(n.t("widget.notepad.prompt.image_url"));if(t)this.exec("insertImage",t)}}" title="${n.t("widget.notepad.tool.image")}">${f.image}</button>
                             <button @click="${(o)=>{o.preventDefault(),this.exec("removeFormat")}}" title="${n.t("widget.notepad.tool.clear_format")}">${f.clear}</button>
                        </div>
                    </div>
                    ...
                    <button class="fab-btn save-btn" @click="${this.saveContent}" title="${n.t("widget.notepad.tool.save")}">${f.save}</button>
                </div>
            `}catch(o){return v`
        ...
        `,this.cpuBar=this.shadowRoot.querySelector(".cpu-bar"),this.ramBar=this.shadowRoot.querySelector(".ram-bar"),this.tempBar=this.shadowRoot.querySelector(".temp-bar"),this.cpuText=this.shadowRoot.querySelector(".cpu-text"),this.ramText=this.shadowRoot.querySelector(".ram-text"),this.tempText=this.shadowRoot.querySelector(".temp-text")}}customElements.define("widget-telemetry",Yt);var Ct=`:host {
...
/* They will now inherit .bookmark-grid__card styles */`;class Ut extends HTMLElement{bookmarks=[];allItems=[];isEditing=!1;searchQuery="";_unsubscribe;_unsubscribeI18n;_resizeObserver;dragTargetId=null;ghostEl=null;dragOffsetX=0;dragOffsetY=0;isResizing=!1;resizeTargetId=null;initialResizeX=0;initialResizeY=0;initialResizeW=0;initialResizeH=0;currentColWidth=0;currentGridCols=12;isTouchDevice=!1;constructor(){super();this.attachShadow({mode:"open"});let o=window.matchMedia("(pointer: coarse)");this.isTouchDevice=o.matches,o.addEventListener("change",(t)=>{this.isTouchDevice=t.matches,this.render()})}_widgetModal;_boundActionClick=this.handleActionClick.bind(this);connectedCallback(){this.render(),this.updateGridMetrics(),this._resizeObserver=new ResizeObserver(()=>{this.updateGridMetrics()}),this._resizeObserver.observe(this),this._unsubscribe=x.subscribe((o)=>{let t=!1;if(this.isEditing!==o.isEditing)this.isEditing=o.isEditing,t=!0;if(this.searchQuery!==o.searchQuery)this.searchQuery=o.searchQuery,t=!0;let r=Array.isArray(o.items)?o.items:[];if(JSON.stringify(this.allItems)!==JSON.stringify(r)||t){if(this.allItems=r,this.searchQuery)this.classList.add("search-active"),this.bookmarks=this.allItems.filter((i)=>{if(i.type!=="bookmark")return!1;return((typeof i.content==="string"?JSON.parse(i.content):i.content).label||"").toLowerCase().includes(this.searchQuery)});else this.classList.remove("search-active"),this.bookmarks=this.allItems;t=!0}if(t)this.render()}),this.setupDragListeners(),this.setupResizeListeners(),this.setupActionListeners(),P.start(),this._unsubscribeI18n=n.subscribe(()=>this.render())}setupActionListeners(){let o=this.shadowRoot;o.removeEventListener("click",this._boundActionClick),o.addEventListener("click",this._boundActionClick)}async handleActionClick(o){if(!this.isEditing)return;let t=o.target;if(!t)return;let r=t.closest(".btn-delete"),e=t.closest(".btn-edit");if(r||e)o.preventDefault(),o.stopPropagation();else if(t.closest("a"))o.preventDefault();if(r){let i=r.closest(".bookmark-grid__card, .bookmark-grid__group, .bookmark-grid__section");if(!i)return;let a=parseInt(i.dataset.id||"0"),s=this.allItems.find((d)=>d.id==a);if(!s)return;let l=s.type==="group"?n.t("type.group"):s.type==="section"?n.t("type.section"):n.t("type.bookmark"),{eventBus:c,EVENTS:p}=await Promise.resolve().then(() => (vo(),Go));c.emit(p.SHOW_CONFIRMATION,{title:`${n.t("general.delete")} ${l}`,message:n.t("bookmark.delete_confirm_message"),onConfirm:()=>{x.deleteItem(a)}});return}if(e){let i=e.closest(".bookmark-grid__card, .bookmark-grid__group");if(!i)return;let a=parseInt(i.dataset.id||"0"),s=this.allItems.find((l)=>l.id==a);if(s){let{eventBus:l,EVENTS:c}=await Promise.resolve().then(() => (vo(),Go));if(s.type==="widget")l.emit(c.SHOW_WIDGET_CONFIG,{item:s,type:"widget"});else l.emit(c.SHOW_WIDGET_CONFIG,{item:s,type:"bookmark"})}return}}disconnectedCallback(){if(this._unsubscribe)this._unsubscribe();if(this._unsubscribeI18n)this._unsubscribeI18n();if(this._resizeObserver)this._resizeObserver.disconnect();P.stop()}updateGridMetrics(){let o=this.getBoundingClientRect(),t=getComputedStyle(this),r=t.getPropertyValue("--current-grid-cols").trim(),e=r?parseInt(r,10):12,i=t.getPropertyValue("--grid-gap").trim(),a=i?parseInt(i,10):16,s=(o.width-(e-1)*a)/e;this.currentGridCols=e,this.currentColWidth=s,this.style.setProperty("--row-height",`${s}px`)}setupResizeListeners(){window.addEventListener("mousemove",this.handleWindowMouseMove.bind(this)),window.addEventListener("mouseup",this.handleWindowMouseUp.bind(this)),this.shadowRoot.addEventListener("mousedown",(o)=>{let t=o;if(!this.isEditing)return;let r=t.target;if(r.classList.contains("resize-handle")){t.preventDefault(),t.stopPropagation();let e=r.closest(".bookmark-grid__card, .bookmark-grid__section");if(!e||!e.dataset.id)return;let i=parseInt(e.dataset.id),a=this.bookmarks.find((b)=>b.id==i);if(!a)return;this.isResizing=!0,this.resizeTargetId=i,this.initialResizeX=t.clientX,this.initialResizeY=t.clientY,this.initialResizeW=a.w,this.initialResizeH=a.h;let s=this,l=s.getBoundingClientRect(),p=getComputedStyle(s).getPropertyValue("--current-grid-cols").trim(),d=p?parseInt(p,10):9,g=isNaN(d)?9:d,h=16;this.currentColWidth=(l.width-(g-1)*h)/g,this.updateGhost({x:a.x,y:a.y,w:a.w,h:a.h},!0)}})}handleWindowMouseMove(o){if(!this.isResizing||!this.resizeTargetId)return;let t=o.clientX-this.initialResizeX,r=o.clientY-this.initialResizeY,e=Math.round(t/(this.currentColWidth+16)),i=Math.round(r/(this.currentColWidth+16)),a=this.initialResizeW+e,s=this.initialResizeH+i,l=this.bookmarks.find((c)=>c.id===this.resizeTargetId);if(l){let c=this.applyResizeConstraints(a,s,l),p={x:l.x,y:l.y,w:c.w,h:c.h,id:l.id,parent_id:l.parent_id},d=L.calculateDropValidity(p,this.bookmarks,this.currentGridCols);this.updateGhost(p,d.valid)}}applyResizeConstraints(o,t,r){let e=1,i=1;if(r.type==="widget"){let s=((typeof r.content==="string"?JSON.parse(r.content):r.content).widgetId||"").toLowerCase();if(s==="notepad")e=2,i=2;else if(s==="clock")return{w:2,h:1};else if(s==="telemetry")return{w:2,h:1};let l=Math.max(e,Math.min(12,o)),c=Math.max(i,Math.min(12,t));return{w:l,h:c}}else if(r.type==="section"){let a=Math.max(1,Math.min(12,o)),s=Math.max(1,Math.min(12,t));return{w:a,h:s}}else{let a=Math.max(1,Math.min(2,o)),s=Math.max(1,Math.min(2,t));return{w:a,h:s}}}async handleWindowMouseUp(o){if(!this.isResizing||!this.resizeTargetId)return;let t=o.clientX-this.initialResizeX,r=o.clientY-this.initialResizeY,e=Math.round(t/(this.currentColWidth+16)),i=Math.round(r/(this.currentColWidth+16)),a=this.initialResizeW+e,s=this.initialResizeH+i,l=this.bookmarks.find((g)=>g.id===this.resizeTargetId);if(!l)return;let c=this.applyResizeConstraints(a,s,l);a=c.w,s=c.h;let p={x:l.x,y:l.y,w:a,h:s,id:l.id,parent_id:l.parent_id};if(L.calculateDropValidity(p,this.bookmarks,this.currentGridCols).valid&&(l.w!==a||l.h!==s)){if(l.type==="section"){let g=a*s,h=this.bookmarks.filter((b)=>b.parent_id===l.id);if(h.sort((b,u)=>b.y-u.y||b.x-u.x),h.length>g){let b=h.slice(g),u=[...this.bookmarks];for(let _ of b){let w=L.findFirstAvailableSlot(_.w,_.h,u,this.currentGridCols);await x.updateItem({id:_.id,x:w.x,y:w.y,parent_id:void 0}),u.push({..._,x:w.x,y:w.y,parent_id:void 0})}}}await x.resizeItem(l.id,a,s)}if(this.isResizing=!1,this.resizeTargetId=null,this.ghostEl)this.ghostEl.style.display="none"}setupDragListeners(){let o=this.shadowRoot,t=this;o.addEventListener("dragstart",(r)=>{let e=r;if(!this.isEditing){e.preventDefault();return}let i=e.target.closest('[draggable="true"]');if(i&&i.dataset.id){this.dragTargetId=parseInt(i.dataset.id),e.dataTransfer.effectAllowed="move",i.style.opacity="0.5";let a=i.getBoundingClientRect();if(this.dragOffsetX=e.clientX-a.left,this.dragOffsetY=e.clientY-a.top,e.dataTransfer)e.dataTransfer.setDragImage(i,this.dragOffsetX,this.dragOffsetY)}}),o.addEventListener("dragend",(r)=>{let e=r.target.closest('[draggable="true"]');if(e)e.style.opacity="1";if(this.dragTargetId=null,this.ghostEl)this.ghostEl.style.display="none";this.shadowRoot.querySelectorAll(".bookmark-grid__section").forEach((a)=>a.classList.remove("drop-target"))}),t.addEventListener("dragover",(r)=>{let e=r;if(!this.isEditing||!this.dragTargetId)return;e.preventDefault(),e.dataTransfer.dropEffect="move";let i=100,a=15,s=document.querySelector(".main-content");if(s){let T=s.getBoundingClientRect(),mo=e.clientY;if(mo>T.bottom-i)s.scrollBy(0,a);else if(mo<T.top+i)s.scrollBy(0,-a);let Ro=t.getBoundingClientRect();if(mo>Ro.bottom-100){let pr=parseFloat(t.style.minHeight)||Ro.height;t.style.minHeight=`${pr+50}px`}}let l=t.getBoundingClientRect(),p=getComputedStyle(this.shadowRoot.host).getPropertyValue("--current-grid-cols").trim(),d=p?parseInt(p,10):12,g=isNaN(d)?12:d,h=l.width,b=16,u=(h-(g-1)*b)/g,_=e.clientX-this.dragOffsetX-l.left,w=e.clientY-this.dragOffsetY-l.top,m=L.snapToGrid(_,w,u,b),B=this.bookmarks.find((T)=>T.id===this.dragTargetId);if(!B)return;let $={x:m.x,y:m.y,w:B.w,h:B.h,id:B.id,parent_id:B.parent_id},H=L.calculateDropValidity($,this.bookmarks,g);if(this.updateGhost($,H.valid),this.shadowRoot.querySelectorAll(".bookmark-grid__section").forEach((T)=>T.classList.remove("drop-target")),H.targetGroup){let T=this.shadowRoot.querySelector(`.bookmark-grid__section[data-id="${H.targetGroup.id}"]`);if(T)T.classList.add("drop-target")}}),t.addEventListener("drop",async(r)=>{let e=r;if(!this.isEditing||!this.dragTargetId)return;e.preventDefault();let i=t.getBoundingClientRect(),s=getComputedStyle(t).getPropertyValue("--current-grid-cols").trim(),l=s?parseInt(s,10):12,c=isNaN(l)?12:l,p=i.width,d=16,g=(p-(c-1)*d)/c,h=e.clientX-this.dragOffsetX-i.left,b=e.clientY-this.dragOffsetY-i.top,u=L.snapToGrid(h,b,g,d),_=this.bookmarks.find(($)=>$.id===this.dragTargetId);if(!_)return;let w={x:u.x,y:u.y,w:_.w,h:_.h,id:_.id,parent_id:_.parent_id},m=L.calculateDropValidity(w,this.bookmarks,c);if(m.valid){let $={id:_.id,x:m.x,y:m.y};if(m.targetGroup)$.parent_id=m.targetGroup.id,$.x=m.x-m.targetGroup.x+1,$.y=m.y-m.targetGroup.y+1;else $.parent_id=void 0;await x.updateItem($)}if(this.ghostEl)this.ghostEl.style.display="none";this.shadowRoot.querySelectorAll(".bookmark-grid__section").forEach(($)=>$.classList.remove("drop-target"))})}updateGhost(o,t){if(!this.ghostEl)this.ghostEl=this.shadowRoot.getElementById("ghost-element");if(!this.ghostEl)return;let r=getComputedStyle(this),e=r.getPropertyValue("--grid-gap").trim(),i=e?parseInt(e,10):16,a=this.getBoundingClientRect(),s=r.getPropertyValue("--current-grid-cols").trim(),l=s?parseInt(s,10):12,p=(a.width-(l-1)*i)/l,d=p,g=(o.x-1)*(p+i),h=(o.y-1)*(d+i),b=o.w*p+(o.w-1)*i,u=o.h*d+(o.h-1)*i;if(this.ghostEl.style.display="block",this.ghostEl.style.setProperty("--x-px",String(g)),this.ghostEl.style.setProperty("--y-px",String(h)),this.ghostEl.style.setProperty("--w-px",String(b)),this.ghostEl.style.setProperty("--h-px",String(u)),t)this.ghostEl.classList.remove("invalid");else this.ghostEl.classList.add("invalid")}render(){if(this.isEditing)this.classList.add("edit-mode");else this.classList.remove("edit-mode");this.shadowRoot.innerHTML=`
            <style>${Ct}</style>
            ${vt({bookmarks:this.bookmarks,isEditing:this.isEditing,isSearching:!!this.searchQuery,isTouchDevice:this.isTouchDevice})}
        `,this.setupActionListeners(),this.ghostEl=this.shadowRoot.getElementById("ghost-element")}}if(!customElements.get("bookmark-grid"))customElements.define("bookmark-grid",Ut);var Ot=()=>`
    <div class="toast-container"></div>
`;var Xt=`.toast-container {
    position: fixed;
    bottom: 20px;
    right: 20px;
    z-index: 1000;
...
`;class or extends HTMLElement{icons=[];filteredIcons=[];selectedIcon="";searchQuery="";isLoading=!0;debounceTimer=null;inputElement=null;id_debug=Math.random().toString(36).substr(2,5);constructor(){super();this.attachShadow({mode:"open"})}async connectedCallback(){if(this.shadowRoot.childElementCount>0)return;if(this.renderBase(),this.setupListeners(),this.icons.length===0)await this.loadIcons()}async loadIcons(){try{this.icons=await qo.loadIcons(),this.filteredIcons=this.icons.slice(0,50),this.isLoading=!1,this.updateGrid()}catch(o){console.error(`[IconPicker:${this.id_debug}] Failed to load icons`,o),this.isLoading=!1,this.updateGrid()}}setupListeners(){let o=this.shadowRoot;this.inputElement=o.getElementById("icon-search"),this.inputElement?.addEventListener("input",(r)=>{let e=r.target;if(this.searchQuery=e.value,this.debounceTimer)window.clearTimeout(this.debounceTimer);this.debounceTimer=window.setTimeout(()=>{this.performSearch()},100)}),o.getElementById("grid-container")?.addEventListener("click",(r)=>{let i=r.target.closest(".icon-picker__item");if(i&&i.dataset.icon)this.selectedIcon=i.dataset.icon,this.updateSelected(),this.updateGrid(),this.dispatchEvent(new CustomEvent("icon-selected",{detail:{iconName:this.selectedIcon},bubbles:!0,composed:!0}))})}performSearch(){this.filteredIcons=qo.searchIcons(this.searchQuery,50),this.updateGrid()}getSelectedIcon(){return this.selectedIcon}setSelectedIcon(o){this.selectedIcon=o,this.updateSelected(),this.updateGrid()}renderBase(){this.shadowRoot.innerHTML=`
            <style>${St}</style>
            ${Dt()}
        `}updateGrid(){let o=this.shadowRoot.getElementById("grid-container");if(o){if(!this.searchQuery.trim()&&!this.isLoading){o.style.display="none",o.innerHTML="";return}o.style.display="grid",o.innerHTML=Wt(this.filteredIcons,this.selectedIcon,this.isLoading)}}updateSelected(){let o=this.shadowRoot.getElementById("selected-container");if(o)o.innerHTML=Pt(this.selectedIcon)}}if(!customElements.get("icon-picker"))customElements.define("icon-picker",or);var tr=({isOpen:o,isEditMode:t})=>`
...
.btn-submit:hover {
    opacity: 0.9;
    transform: translateY(-1px);
}`;class er extends HTMLElement{isOpen=!1;iconPicker=null;selectedIconName="";clickHandler=null;submitHandler=null;escapeHandler=null;_unsubscribeI18n;isEditMode=!1;currentItemId=null;constructor(){super();this.attachShadow({mode:"open"}),this.setupHandlers()}setupHandlers(){this.clickHandler=(o)=>{let t=o.target;if(t.id==="modal-overlay"){this.close();return}if(t.closest("#modal-close")){o.preventDefault(),o.stopPropagation(),this.close();return}},this.submitHandler=async(o)=>{o.preventDefault(),o.stopPropagation();let t=o.target,r=new FormData(t),e=r.get("label"),i=r.get("url"),a=r.get("statusCheck")==="on",s=this.iconPicker?this.iconPicker.getSelectedIcon():"",l=s?`https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/${s}.png`:"";try{let c=JSON.stringify({label:e,url:i,icon:l,iconName:s,statusCheck:a});if(this.isEditMode&&this.currentItemId){if(await x.updateItem({id:this.currentItemId,content:c}),window.notifier)window.notifier.show(n.t("notifier.bookmark_updated"))}else{let p=x.getState(),d=Array.isArray(p.items)?p.items:[];Promise.resolve().then(() => (O(),D)).then(async({collisionService:g})=>{let h=g.findFirstAvailableSlot(1,1,d);if(await x.addItem({type:"bookmark",x:h.x,y:h.y,w:1,h:1,content:c}),window.notifier)window.notifier.show(n.t("notifier.bookmark_added"))})}this.close()}catch(c){if(console.error("[Modal] Error:",c),window.notifier)window.notifier.show(n.t("notifier.bookmark_error"),"error")}},this.escapeHandler=(o)=>{if(o.key==="Escape"&&this.isOpen)this.close()}}connectedCallback(){this.render(),this.setupListeners(),this._unsubscribeI18n=n.subscribe(()=>{if(this.isOpen)this.render()})}disconnectedCallback(){if(this._unsubscribeI18n)this._unsubscribeI18n();let o=this.shadowRoot;if(this.clickHandler)o.removeEventListener("click",this.clickHandler);if(this.submitHandler)o.removeEventListener("submit",this.submitHandler);if(this.escapeHandler)document.removeEventListener("keydown",this.escapeHandler)}setupListeners(){let o=this.shadowRoot;o.addEventListener("click",this.clickHandler),o.addEventListener("submit",this.submitHandler),document.addEventListener("keydown",this.escapeHandler)}open(){this.isOpen=!0,this.isEditMode=!1,this.currentItemId=null,this.render(),this.initializeIconPicker(),setTimeout(()=>{let o=this.shadowRoot.getElementById("bookmark-label");if(o)o.focus()},100)}openForEdit(o){this.isOpen=!0,this.isEditMode=!0,this.currentItemId=o.id;let t=o.content;if(typeof t==="string")try{t=JSON.parse(t)}catch(r){console.error("Failed to parse item content",r)}this.selectedIconName=t.iconName||"",this.render(),this.initializeIconPicker(),setTimeout(()=>{let r=this.shadowRoot.getElementById("bookmark-form");if(r){let e=r.elements.namedItem("label"),i=r.elements.namedItem("url"),a=r.elements.namedItem("statusCheck");if(e)e.value=t.label||"";if(i)i.value=t.url||"";if(a)a.checked=!!t.statusCheck}if(this.iconPicker)this.iconPicker.setSelectedIcon(this.selectedIconName)},100)}close(){this.isOpen=!1,this.selectedIconName="",this.resetForm(),this.render()}resetForm(){setTimeout(()=>{let o=this.shadowRoot.getElementById("bookmark-form");if(o)o.reset();if(this.iconPicker)this.iconPicker.setSelectedIcon("")},100)}initializeIconPicker(){requestAnimationFrame(()=>{let o=this.shadowRoot.getElementById("icon-picker-container");if(!o){console.error("[Modal] Icon picker container not found");return}if(!this.iconPicker)this.iconPicker=document.createElement("icon-picker"),this.iconPicker.addEventListener("icon-selected",(t)=>{this.selectedIconName=t.detail.iconName});o.innerHTML="",o.appendChild(this.iconPicker)})}render(){this.shadowRoot.innerHTML=`
            <style>${rr}</style>
            ${tr({isOpen:this.isOpen,isEditMode:this.isEditMode})}
        `}}if(!customElements.get("add-bookmark-modal"))customElements.define("add-bookmark-modal",er);var Ko=[{id:"clock",name:"Clock",icon:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>',description:"Digital clock with date",defaultW:2,defaultH:1,componentTag:"widget-clock"},{id:"notepad",name:"Notepad",icon:'<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>',description:"Simple sticky note",defaultW:2,defaultH:2,componentTag:"widget-notepad"},{id:"telemetry",name:"System Status",icon:'<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg>',description:"CPU, RAM and Temp",defaultW:2,defaultH:1,componentTag:"widget-telemetry"}];class ir extends HTMLElement{dialog=null;constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}open(){if(this.dialog)this.dialog.showModal()}close(){if(this.dialog)this.dialog.close()}selectWidget(o){this.dispatchEvent(new CustomEvent("widget-selected",{detail:o,bubbles:!0,composed:!0})),this.close()}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: contents;
                }
        ...
        `,this.dialog=this.shadowRoot.querySelector("dialog"),this.shadowRoot.querySelectorAll(".card").forEach((o)=>{o.addEventListener("click",()=>{let t=o.getAttribute("data-id"),r=Ko.find((e)=>e.id===t);if(r)this.selectWidget(r)})})}}customElements.define("add-widget-modal",ir);class nr extends HTMLElement{dialog=null;currentItem=null;constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}open(o){if(this.currentItem=o,this.render(),this.dialog)this.dialog.showModal()}close(){if(this.dialog)this.dialog.close();this.currentItem=null}async save(){if(!this.currentItem)return;let o=typeof this.currentItem.content==="string"?JSON.parse(this.currentItem.content):this.currentItem.content,t=o.widgetId,r={...o};if(t==="clock"){let e=this.shadowRoot?.getElementById("clock-tz"),i=this.shadowRoot?.getElementById("clock-12h"),a=this.shadowRoot?.getElementById("clock-date");r.timezone=e?.value||"local",r.hour12=i?.checked||!1,r.showDate=a?.checked||!1,r.timezone=e?.value||"local",r.hour12=i?.checked||!1,r.showDate=a?.checked||!1}else if(t==="telemetry"){let e=this.shadowRoot?.getElementById("telemetry-interval");r.interval=e?parseInt(e.value):1000}await x.updateItem({id:this.currentItem.id,content:JSON.stringify(r)}),this.close()}render(){if(!this.shadowRoot)return;let o={},t="";if(this.currentItem)o=typeof this.currentItem.content==="string"?JSON.parse(this.currentItem.content):this.currentItem.content,t=o.widgetId;let r=()=>{if(!this.currentItem)return"";if(t==="clock"){let i=o.timezone||"local",a=o.hour12||!1,s=o.showDate!==!1;return`
                    ...
                    <div class="field-group check-row">
                        <input type="checkbox" id="clock-12h" ${a?"checked":""} />
...
.btn-confirm:active {
    transform: translateY(0);
        ...
        `}}vo();var j=document.getElementById("main-topbar"),dr=document.getElementById("right-drawer"),_o=document.getElementById("dashboard-root"),V,fo,uo;cr(async()=>{if(R.init(),R.sync(),await k.fetchUser(),j){let t=k.getUser();if(j.setState({user:t}),t&&t.project_name)j.setAttribute("title",t.project_name);k.subscribe((r)=>{if(r){if(j.setState({user:r}),r.project_name)j.setAttribute("title",r.project_name)}})}await x.fetchItems(),Yr(),P.start(),V=document.createElement("add-bookmark-modal"),document.body.appendChild(V),fo=document.createElement("add-widget-modal"),document.body.appendChild(fo),uo=document.createElement("confirmation-modal"),document.body.appendChild(uo);let o=document.createElement("widget-config-modal");document.body.appendChild(o)});so.on(ao.SHOW_CONFIRMATION,async(o)=>{let{title:t,message:r,onConfirm:e}=o.detail;if(uo){if(await uo.confirm(t,r)&&e)e()}});so.on(ao.SHOW_WIDGET_CONFIG,(o)=>{let{item:t,type:r}=o.detail;if(r==="bookmark"){if(V)V.openForEdit(t)}else{let e=document.querySelector("widget-config-modal");if(e)e.open(t)}});so.on(ao.NOTIFY,(o)=>{let t=document.querySelector("app-notifier");if(t)t.show(o.detail.message,o.detail.type)});if(j)j.addEventListener("drawer-toggle",(o)=>{if(o.detail.action==="open")dr.open(),j.setState({drawerOpen:!0});else dr.close(),j.setState({drawerOpen:!1})}),j.addEventListener("edit-mode-change",(o)=>{let t=o.detail.active;if(_o.classList.toggle("edit-mode",t),!t)window.location.reload()}),j.addEventListener("search-input",(o)=>{let t=o.detail.query;x.setSearchQuery(t)}),j.addEventListener("add-item",(o)=>{let t=o.detail.action;if(t==="add-bookmark"){if(V)V.open()}else if(t==="add-widget"){if(fo)fo.open()}else if(t==="add-section"){let e=x.getState().items||[];Promise.resolve().then(() => (O(),D)).then(({collisionService:i})=>{let a=i.findFirstAvailableSlot(1,1,e),s={type:"section",x:a.x,y:a.y,w:1,h:1,content:JSON.stringify({name:""})};x.addItem(s)})}});window.addEventListener("widget-selected",(o)=>{let r=o.detail,i=x.getState().items||[];Promise.resolve().then(() => (O(),D)).then(({collisionService:a})=>{let s=a.findFirstAvailableSlot(r.defaultW,r.defaultH,i),l={type:"widget",x:s.x,y:s.y,w:r.defaultW,h:r.defaultH,content:JSON.stringify({widgetId:r.id,text:r.id==="notepad"?"":void 0})};x.addItem(l)})});window.addEventListener("drawer-close",()=>{if(j)j.setState({drawerOpen:!1})});window.addEventListener("click",(o)=>{let t=o.target,r=document.getElementById("add-menu"),e=document.getElementById("add-toggle");if(r&&r.classList.contains("active")&&!r.contains(t)&&e&&!e.contains(t))r.classList.remove("active")});function Yr(){if(!_o)return;_o.innerHTML="";let o=document.createElement("bookmark-grid");_o.appendChild(o)}
