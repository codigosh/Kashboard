...
.paper {
    ...
    height: 100%;
}`;class Oo extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            <style>${No}</style>
            ${Uo()}
        `}}if(!customElements.get("app-paper"))customElements.define("app-paper",Oo);var Eo=`:host {
...
.avatar__initials {
    user-select: none;
}`;v();class Co extends HTMLElement{static get observedAttributes(){return["src","alt","initials"]}constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}attributeChangedCallback(o,r,t){if(r!==t)this.render()}render(){let o=this.getAttribute("src"),r=this.getAttribute("initials")||"??",t=this.getAttribute("alt")||i.t("general.user_avatar");this.shadowRoot.innerHTML=`
            <style>${Do}</style>
            ${To({src:o||void 0,initials:r,alt:t})}
        `}}if(!customElements.get("app-avatar"))customElements.define("app-avatar",Co);v();U();xo();v();var Po=(o)=>`
...
`,bt=(o,r)=>{if(!o)return"";if(!r)return"";if(r.is_docker)return`
    ...
    `},uo=(o,r,t)=>{return`
        ...
        `:""}
    `},rr=(o,r,t,a,n)=>{let e=t?.toLowerCase()==="admin"||t?.toLowerCase()==="administrator";return`
...
`;class ar extends HTMLElement{static get observedAttributes(){return["value","trigger-opacity"]}_value="#0078D4";_h=210;_s=100;_v=83;_popover=null;_satArea=null;_satCursor=null;_hueSlider=null;_hueCursor=null;_hexInput=null;_preview=null;_isDraggingSat=!1;_isDraggingHue=!1;constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.bindEvents(),this.hexToHsv(this._value),this.updateUI()}get value(){return this._value}set value(o){if(this._value!==o){if(this._value=o,this.hexToHsv(o),this.updateUI(),this._hexInput)this._hexInput.value=o}}attributeChangedCallback(o,r,t){if(o==="value"&&r!==t)this.value=t;else if(o==="trigger-opacity"&&r!==t)this.updateTriggerOpacity(t)}updateTriggerOpacity(o){if(this.shadowRoot){let r=this.shadowRoot.getElementById("trigger");if(r)r.style.opacity=o}}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
            <style>${_o}</style>
...
@keyframes blink {
    ...
    100% {
        ...
        `}}if(!customElements.get("app-topbar"))customElements.define("app-topbar",lr);v();var gr=()=>`
    <div class="dot"></div>
...
@keyframes fadeIn {
    ...
    to {
        ...
        transform: translateY(0);
            ...
            <style>${xr}</style>
            ${gr()}
        `}}if(!customElements.get("offline-badge"))customElements.define("offline-badge",br);v();var hr=({title:o,dropdownOpen:r})=>`
    <header class="header">
...
(max-width: 1024px) {
...
}`;class vr extends HTMLElement{dropdownOpen;constructor(){super();this.attachShadow({mode:"open"}),this.dropdownOpen=!1}connectedCallback(){this.render(),this.setupListeners()}toggleDropdown(o){this.dropdownOpen=typeof o==="boolean"?o:!this.dropdownOpen,this.render()}setupListeners(){this.shadowRoot.addEventListener("click",(o)=>{let r=o.target,t=r.closest(".header__btn-changelog");if(t)t.style.display="none";if(r.closest("#profile-trigger"))o.stopPropagation(),this.toggleDropdown()}),window.addEventListener("click",()=>{if(this.dropdownOpen)this.toggleDropdown(!1)})}render(){let o=this.getAttribute("title")||"Task";this.shadowRoot.innerHTML=`
            <style>${fr}</style>
            ${hr({title:o,dropdownOpen:this.dropdownOpen})}
        `}}if(!customElements.get("app-header"))customElements.define("app-header",vr);v();var D=(o)=>String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),kt=(o)=>{if(!o)return"#";let r=o.trim().toLowerCase();if(r.startsWith("http://")||r.startsWith("https://")||r==="#")return D(o);return"#"},ur=({bookmarks:o,isEditing:r,isLoading:t,isSearching:a,isTouchDevice:n,maxCols:e=12})=>{let s=Array.isArray(o)?o:[];if(t&&s.length===0)return zt(e);let p=(l)=>s.filter((c)=>c.parent_id===l);return`
    ${(n?s:a?s:s.filter((l)=>!l.parent_id)).map((l)=>{let c={};try{c=typeof l.content==="string"?JSON.parse(l.content):l.content}catch(m){console.error("Failed to parse content for item",l.id,m)}let x=l.type==="section",u={x:l.x||1,y:l.y||1},f=Math.min(l.w||1,e),y=l.h||1;if(x){let m=p(l.id),k=(c.title||"").trim(),b=c.borderColor&&!r?`border-color: ${c.borderColor} !important;`:"",A=!r?`border-width: ${c.borderWidth||1}px !important;`:"";return`
            <fieldset class="bookmark-grid__section"
               ...
               `:""}
            </fieldset>`}return mr(l,c,r,u,f,y,n)}).join("")}

    <div id="ghost-element" class="bookmark-grid__ghost" style="display: none;"></div>
    `};function mr(o,r,t,a,n,e=0,s=!1){let p=e||o.h||1;if(o.type==="widget"){let m=r.widgetId,b={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry",weather:"widget-weather",markdown:"widget-markdown"}[m]||"div",H=(r.text||"").replace(/"/g,"&quot;"),h=r.borderColor&&!t?`border-color: ${r.borderColor} !important;`:"",Y=!t?`border-width: ${r.borderWidth||1}px !important;`:"";return`
        <div class="bookmark-grid__card"
            draggable="${t}"
            data-id="${o.id}"
            data-type="${o.type}"
            data-orig-x="${o.x}" data-orig-y="${o.y}"
            ${!s?`style="--x: ${a.x}; --y: ${a.y}; --w: ${n}; --h: ${p}; ${h} ${Y}"`:""}>
    ...
    `}function wt(o,r,t=!1,a=12,n=!1){return o.map((e)=>{let s={};try{s=typeof e.content==="string"?JSON.parse(e.content):e.content}catch(c){console.error("Failed to parse content for item (nested)",e.id,c)}let p={x:e.x||1,y:e.y||1},d=e.h||1,l=Math.min(e.w||1,a);return mr(e,s,r,p,l,d,n)}).join("")}function zt(o){return`
        <style>
            .skeleton {
                background: var(--surface);
                pointer-events: none;
...
`;class yr extends HTMLElement{_itemId=0;_content="";_isDirty=!1;_isLocked=!0;_isSaving=!1;_lastLockTime=0;_editor=null;_syncStatus=null;_dock=null;_editorContainer=null;_modal=null;_imgResizer=null;_activeImage=null;_pendingAction=null;static get observedAttributes(){return["item-id"]}constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.loadContent(),window.addEventListener("beforeunload",this.handleBeforeUnload.bind(this)),i.subscribe(()=>{if(this._editor)this._editor.dataset.placeholder=i.t("widget.notepad.placeholder")})}disconnectedCallback(){window.removeEventListener("beforeunload",this.handleBeforeUnload.bind(this))}attributeChangedCallback(o,r,t){if(o==="item-id")this._itemId=parseInt(t),this.loadContent()}handleBeforeUnload(o){if(this._isDirty)o.preventDefault(),o.returnValue=""}render(){if(!this.shadowRoot)return;let o=this._isLocked?"locked":"unlocked",r=this._isLocked?"locked":"",t=this._isLocked?"hidden":"";this.shadowRoot.innerHTML=`
        ...
        `,this.cpuBar=this.shadowRoot.querySelector(".cpu-bar"),this.ramBar=this.shadowRoot.querySelector(".ram-bar"),this.tempBar=this.shadowRoot.querySelector(".temp-bar"),this.cpuText=this.shadowRoot.querySelector(".cpu-text"),this.ramText=this.shadowRoot.querySelector(".ram-text"),this.tempText=this.shadowRoot.querySelector(".temp-text")}}customElements.define("widget-telemetry",kr);v();j();var wr=new Map,$r=900000,zr={widgetId:"weather",latitude:0,longitude:0,city:"",unit:"celsius",showForecast:!1,forecastDays:5};function C(o){if(o===0)return`<svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
...
@keyframes pulse {
...
}`;class Zr extends HTMLElement{icons=[];filteredIcons=[];selectedIcon="";searchQuery="";isLoading=!0;debounceTimer=null;inputElement=null;constructor(){super();this.attachShadow({mode:"open"})}async connectedCallback(){if(this.shadowRoot.childElementCount>0)return;if(this.renderBase(),this.setupListeners(),this.icons.length===0)await this.loadIcons()}async loadIcons(){try{this.icons=await wo.loadIcons(),this.filteredIcons=this.icons.slice(0,50),this.isLoading=!1,this.updateGrid()}catch(o){console.error("[IconPicker] Failed to load icons",o),this.isLoading=!1,this.updateGrid()}}setupListeners(){let o=this.shadowRoot;this.inputElement=o.getElementById("icon-search"),this.inputElement?.addEventListener("input",(t)=>{let a=t.target;if(this.searchQuery=a.value,this.debounceTimer)window.clearTimeout(this.debounceTimer);this.debounceTimer=window.setTimeout(()=>{this.performSearch()},100)}),o.getElementById("grid-container")?.addEventListener("click",(t)=>{let n=t.target.closest(".icon-picker__item");if(n&&n.dataset.icon)this.selectedIcon=n.dataset.icon,this.updateGrid(),this.dispatchEvent(new CustomEvent("icon-selected",{detail:{iconName:this.selectedIcon},bubbles:!0,composed:!0}))})}performSearch(){this.filteredIcons=wo.searchIcons(this.searchQuery,50),this.updateGrid()}getSelectedIcon(){return this.selectedIcon}setSelectedIcon(o){this.selectedIcon=o,this.updateGrid()}renderBase(){this.shadowRoot.innerHTML=`
            <style>${Rr}</style>
            ${Qr()}
        `}updateGrid(){let o=this.shadowRoot.getElementById("grid-container");if(o){if(o.style.display="grid",!this.searchQuery.trim()&&!this.isLoading){o.innerHTML='<div class="icon-picker__empty">Start typing to search icons...</div>';return}o.innerHTML=Gr(this.filteredIcons,this.selectedIcon,this.isLoading)}}}if(!customElements.get("icon-picker"))customElements.define("icon-picker",Zr);v();var Yr=["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#64748b","#f8fafc","#1e293b","#333333"],Mt=(o,r)=>{let t=!Yr.includes(o)&&o!=="";return`
    ...
    `},Br=({isOpen:o,isEditMode:r,title:t,url:a,protocol:n,selectedIcon:e,color:s,statusPosition:p,checkStatus:d,labelPosition:l,visibleTouch:c,borderWidth:x})=>`
    <dialog id="modal">
        <div class="modal-header">
...
.premium-swatch-picker {
    ...
    /* Ensure it's on top */
        ...
        `,this.dialog=this.shadowRoot.querySelector("dialog"),this.shadowRoot.querySelectorAll(".card").forEach((o)=>{o.addEventListener("click",()=>{let r=o.getAttribute("data-id"),t=zo.find((a)=>a.id===r);if(t)this.selectWidget(t)})})}}customElements.define("add-widget-modal",Er);j();v();var Vr=`:host {
    display: contents;
}
...
.modal-actions {
    ...
    justify-content: flex-end;
        ...
        `,this.setupDynamicListeners()}}if(!customElements.get("confirmation-modal"))customElements.define("confirmation-modal",Wr);v();var Ir=({title:o,message:r})=>`
    <dialog id="modal">
        <div class="modal-header">
...
@keyframes shake {
    ...
    80% {
        ...
        `}}to();var L=document.getElementById("main-topbar"),at=document.getElementById("right-drawer"),ao=document.getElementById("dashboard-root"),P,io,no,eo;tt(async()=>{F.init();let[o,r]=await Promise.all([w.fetchUser(),g.fetchItems()]),t=w.getUser();if(t){if(t.language)await i.setLanguage(t.language);if(t.preferences&&t.preferences.grid_columns)document.documentElement.style.setProperty("--user-preferred-columns",t.preferences.grid_columns.toString());if(t.theme==="dark")F.enableDark();else if(t.theme==="light")F.enableLight();else if(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)F.enableDark();else F.enableLight();if(t.id)g.setUserId(t.id)}if(L){if(L.setState({user:t}),t&&t.project_name)L.setAttribute("title",t.project_name);w.subscribe((n)=>{if(n){if(L.setState({user:n}),n.project_name)L.setAttribute("title",n.project_name)}})}Bt(),I.start(),P=document.createElement("add-bookmark-modal"),document.body.appendChild(P),io=document.createElement("add-widget-modal"),document.body.appendChild(io),no=document.createElement("confirmation-modal"),document.body.appendChild(no),eo=document.createElement("password-confirm-modal"),document.body.appendChild(eo);let a=document.createElement("widget-config-modal");document.body.appendChild(a)});E.on(O.SHOW_CONFIRMATION,async(o)=>{let{title:r,message:t,onConfirm:a}=o.detail;if(no){if(await no.confirm(r,t)&&a)a()}});E.on(O.SHOW_PASSWORD_CONFIRM,async(o)=>{let{title:r,message:t,onConfirm:a}=o.detail;if(eo){let n=await eo.prompt(r,t);if(n!==null&&a)a(n)}});E.on(O.SHOW_WIDGET_CONFIG,(o)=>{let{item:r,type:t}=o.detail;if(t==="bookmark"){if(P)P.openForEdit(r)}else{let a=document.querySelector("widget-config-modal");if(a)a.open(r)}});E.on(O.NOTIFY,(o)=>{let r=document.querySelector("app-notifier");if(r)r.show(o.detail.message,o.detail.type)});if(L)L.addEventListener("drawer-toggle",(o)=>{if(o.detail.action==="open")at.open(),L.setState({drawerOpen:!0});else at.close(),L.setState({drawerOpen:!1})}),L.addEventListener("edit-mode-change",(o)=>{let r=o.detail.active;if(ao.classList.toggle("edit-mode",r),!r)window.location.reload()}),L.addEventListener("search-input",(o)=>{let r=o.detail.query;g.setSearchQuery(r)}),L.addEventListener("add-item",async(o)=>{let r=o.detail.action;if(r==="add-bookmark"){if(P)P.open()}else if(r==="add-widget"){if(io)io.open()}else if(r==="add-section"){let a=g.getState().items||[],{collisionService:n}=await Promise.resolve().then(() => (N(),T)),e=n.findFirstAvailableSlot(1,1,a),s={type:"section",x:e.x,y:e.y,w:1,h:1,content:JSON.stringify({title:""})},p=await g.addItem(s);if(p)E.emit(O.SHOW_WIDGET_CONFIG,{item:p,type:"section"})}});window.addEventListener("widget-selected",async(o)=>{let t=o.detail,n=g.getState().items||[],{collisionService:e}=await Promise.resolve().then(() => (N(),T)),s=e.findFirstAvailableSlot(t.defaultW,t.defaultH,n),p={type:"widget",x:s.x,y:s.y,w:t.defaultW,h:t.defaultH,content:JSON.stringify({widgetId:t.id,text:t.id==="notepad"||t.id==="markdown"?"":void 0})};await g.addItem(p)});window.addEventListener("drawer-close",()=>{if(L)L.setState({drawerOpen:!1})});window.addEventListener("click",(o)=>{let r=o.target,t=document.getElementById("add-menu"),a=document.getElementById("add-toggle");if(t&&t.classList.contains("active")&&!t.contains(r)&&a&&!a.contains(r))t.classList.remove("active")});function Bt(){if(!ao)return;ao.innerHTML="";let o=document.createElement("bookmark-grid");ao.appendChild(o)}
