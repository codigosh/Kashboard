...
.right-drawer__menu-item--logout:hover {
    background: rgba(250, 82, 82, 0.05) !important;
        ...
        `}}if(!customElements.get("app-right-drawer"))customElements.define("app-right-drawer",xt);var ht=({title:o,editMode:t,searchActive:r,addMenuActive:a,drawerOpen:i,searchQuery:e,user:s,updateAvailable:l})=>{let d=s?.role?.toLowerCase()==="admin"||s?.role==="Administrator";return`
    <div class="top-bar">
...
@keyframes blink {
    ...
    100% {
        ...
        transform: scale(1);
            ...
            <style>${bt}</style>
            ${ht({title:o,editMode:this.state.editMode,searchActive:this.state.searchActive,addMenuActive:this.state.addMenuActive,drawerOpen:this.state.drawerOpen,searchQuery:this.state.searchQuery,user:this.state.user,updateAvailable:this.state.updateAvailable})}
