...
.btn--danger:hover {
    ...
    border-color: var(--accent);
        ...
        `}}if(!customElements.get("app-button"))customElements.define("app-button",Go);var Co=({src:o,initials:t,alt:r})=>`
...
(max-width: 1024px) {
    ...
    `};function it(o,t,r,i,n,e=0,s=!1){let d=e||o.h||1;if(o.type==="widget"){let y=t.widgetId,x={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry",weather:"widget-weather",markdown:"widget-markdown"}[y]||"div",L=(t.text||"").replace(/"/g,"&quot;");return`
...
.btn:active {
    transform: translateY(1px);
        ...
        `,this.dialog=this.shadowRoot.querySelector("dialog"),this.shadowRoot.querySelectorAll(".card").forEach((o)=>{o.addEventListener("click",()=>{let t=o.getAttribute("data-id"),r=vo.find((i)=>i.id===t);if(r)this.selectWidget(r)})})}}customElements.define("add-widget-modal",At);M();f();var Lt=`:host {
    display: contents;
}
