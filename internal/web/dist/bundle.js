...
`,Nt=(o,t)=>{if(!o)return"";if(!t)return"";if(t.is_docker)return`
...
(max-width: 1024px) {
    ...
    ${(n?s:i?s:s.filter((c)=>!c.parent_id)).map((c)=>{let l={};try{l=typeof c.content==="string"?JSON.parse(c.content):c.content}catch(y){console.error("Failed to parse content for item",c.id,y)}let h=c.type==="section",w={x:c.x||1,y:c.y||1},u=Math.min(c.w||1,e),_=c.h||1;if(h){let y=d(c.id),m=(l.title||"").trim();return`
                        ...
                        <div class="input-group">
                            <div class="icon-dropdown">
                                <button type="button" class="icon-dropdown-btn" id="touch-pos-btn" style="position: relative;">
                                    ${l?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 15l-4-4 1.41-1.41L11 14.17l5.59-5.59L18 10z"/></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10" stroke-opacity="0.5" /><path d="M15 9l-6 6M9 9l6 6" /></svg>'}
                                    <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="position: absolute; bottom: 1px; right: 1px; opacity: 0.7;">
                                        <path d="M7 10l5 5 5-5z" />
                                    </svg>
                                </button>
...
dialog {
    ...
    max-height: 85vh;
    height: 640px;
    /* Increased for fixed layout and "luxury" spacing */
    display: none;
    /* Hidden by default */
    flex-direction: column;
    backdrop-filter: blur(20px);
...
@keyframes fadeContent {
    ...
    to {
        ...
        transform: translateY(0);
                ...
                `;return{general:l,customization:h}}else if(t==="weather"){let d=o.city||"",p=o.latitude||"",c=o.longitude||"",l=o.unit==="fahrenheit",h=o.showForecast||!1,w=o.forecastDays||5,u=`
                    <div class="field-group">
