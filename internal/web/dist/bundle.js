...
.status-up {
    ...
    /* Removed heavy animated box-shadow */
}
...
.status-up::after {
    ...
    border-radius: 50%;
    background: #2ecc71;
    animation: status-pulse-gpu 2.5s infinite cubic-bezier(0.1, 0.7, 0.3, 1);
    z-index: -1;
    pointer-events: none;
    will-change: transform, opacity;
}
...
.border-width-btn span {
    ...
    font-weight: 500;
                ...
                `,_="";return{general:y,customization:""+p()}}else if(r==="telemetry"){let d=o.interval||1000,c=`
                    <p style="color: var(--text-dim); font-size: 13px; margin-bottom: 16px;">${a.t("widget.telemetry.description")}</p>
