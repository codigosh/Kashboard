var gr=Object.defineProperty;var ut=(t,o)=>{for(var r in o)gr(t,r,{get:o[r],enumerable:!0,configurable:!0,set:(e)=>o[r]=()=>e})};var R=function(t,o,r,e){var i=arguments.length,n=i<3?o:e===null?e=Object.getOwnPropertyDescriptor(o,r):e,s;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")n=Reflect.decorate(t,o,r,e);else for(var l=t.length-1;l>=0;l--)if(s=t[l])n=(i<3?s(n):i>3?s(o,r,n):s(o,r))||n;return i>3&&n&&Object.defineProperty(o,r,n),n};var Q=(t,o)=>{if(typeof Reflect==="object"&&typeof Reflect.metadata==="function")return Reflect.metadata(t,o)},yt=(t,o)=>()=>(t&&(o=t(t=0)),o);var Mt={};ut(Mt,{socketService:()=>xr});class qt{socket=null;listeners=[];reconnectTimeout;constructor(){this.connect()}connect(){let t=window.location.protocol==="https:"?"wss:":"ws:",o=window.location.host,r=`${t}//${o}/ws`;this.socket=new WebSocket(r),this.socket.onmessage=(e)=>{try{let i=JSON.parse(e.data);this.notify(i)}catch(i){console.error("[SocketService] Failed to parse message",i)}},this.socket.onclose=()=>{console.warn("[SocketService] WebSocket closed. Reconnecting..."),this.scheduleReconnect()},this.socket.onerror=(e)=>{console.error("[SocketService] WebSocket error",e),this.socket?.close()}}scheduleReconnect(){if(this.reconnectTimeout)clearTimeout(this.reconnectTimeout);this.reconnectTimeout=setTimeout(()=>this.connect(),5000)}subscribe(t){return this.listeners.push(t),()=>{this.listeners=this.listeners.filter((o)=>o!==t)}}notify(t){this.listeners.forEach((o)=>o(t))}}var xr;var Jt=yt(()=>{xr=new qt});var V={};ut(V,{collisionService:()=>E});var E;var Z=yt(()=>{E={isOverlap(t,o){return t.x<o.x+o.w&&t.x+t.w>o.x&&t.y<o.y+o.h&&t.y+t.h>o.y},calculateDropValidity(t,o,r=12){let e=Number(t.x),i=Number(t.y),n=Number(t.w),s=Number(t.h);if(e<1||e+n-1>r||i<1)return{valid:!1,x:e,y:i};let c=o.find((d)=>d.id===t.id)?.type==="section",p={x:e,y:i,w:n,h:s};for(let d of o){if(d.id===t.id)continue;let g=Number(d.x),h=Number(d.y),b=Number(d.w||1),f=Number(d.h||1),_={x:g,y:h,w:b,h:f};if(d.parent_id){let w=o.find((u)=>u.id===d.parent_id);if(w)_.x=Number(w.x)+g-1,_.y=Number(w.y)+h-1;else continue}if(this.isOverlap(p,_)){if(!c&&d.type==="section"){let w=e-Number(d.x)+1,u=i-Number(d.y)+1;if(w<1||w+n-1>Number(d.w||1)||u<1||u+s-1>Number(d.h||1))return{valid:!1,x:e,y:i};let H=o.filter((L)=>L.parent_id===d.id),$=!1;for(let L of H){let Rt={x:Number(L.x),y:Number(L.y),w:Number(L.w||1),h:Number(L.h||1)},j={x:w,y:u,w:n,h:s};if(this.isOverlap(j,Rt)){$=!0;break}}if(!$)return{valid:!0,x:e,y:i,targetGroup:d}}return{valid:!1,x:e,y:i}}}return{valid:!0,x:e,y:i}},snapToGrid(t,o,r,e){let i=r+e,n=Math.max(1,Math.floor(t/i)+1),s=r+e,l=Math.max(1,Math.floor(o/s)+1);return{x:n,y:l}},findFirstAvailableSlot(t,o,r,e=12){let i=1;while(!0){for(let n=1;n<=e-t+1;n++){let s={x:n,y:i,w:t,h:o},l=!1;for(let c of r){let{x:p,y:d}=c,g=c.w||1,h=c.h||1;if(c.parent_id){let f=r.find((_)=>_.id===c.parent_id);if(f)p=f.x+c.x-1,d=f.y+c.y-1;else continue}let b={x:p,y:d,w:g,h};if(this.isOverlap(s,b)){l=!0;break}}if(!l)return{x:n,y:i}}if(i++,i>1000)return{x:1,y:1000}}},findAvailableSlot(t,o,r,e){let i=1;while(!0){for(let n=1;n<=e-t+1;n++){let s={x:n,y:i,w:t,h:o},l=!1;for(let c of r)if(this.isOverlap(s,c)){l=!0;break}if(!l)return{x:n,y:i}}if(i++,i>1000)return{x:1,y:1000}}}}});var Ft={};ut(Ft,{eventBus:()=>st,EVENTS:()=>nt});var nt,Oo,st;var bt=yt(()=>{nt={SHOW_CONFIRMATION:"kashboard:show-confirmation",SHOW_WIDGET_CONFIG:"kashboard:show-widget-config",NOTIFY:"kashboard:notify"};Oo=class Oo extends EventTarget{emit(t,o){this.dispatchEvent(new CustomEvent(t,{detail:o}))}on(t,o){this.addEventListener(t,o)}off(t,o){this.removeEventListener(t,o)}};st=new Oo});class Nt{baseUrl;constructor(){this.baseUrl=window.CSH_CONFIG?.API_BASE_URL||""}async request(t,o){let r=`${this.baseUrl}${t}`;try{let e=await fetch(r,{...o,headers:{"Content-Type":"application/json",...o.headers}});if(!e.ok){let n=await e.json().catch(()=>({}));throw Error(n.error||`HTTP ${e.status}: ${e.statusText}`)}let i=await e.text();return i?JSON.parse(i):{}}catch(e){throw console.error(`[ApiService] Request failed: ${r}`,e),e}}async get(t){return this.request(t,{method:"GET"})}async post(t,o){return this.request(t,{method:"POST",body:JSON.stringify(o)})}async patch(t,o){return this.request(t,{method:"PATCH",body:JSON.stringify(o)})}async put(t,o){return this.request(t,{method:"PUT",body:JSON.stringify(o)})}async delete(t){return this.request(t,{method:"DELETE"})}}var z=new Nt;var A={async getCurrentUser(){return z.get("/api/me")},async updateProfile(t){return z.post("/api/user/update-profile",t)},async updatePreferences(t){return z.post("/api/user/preferences",t)},async changePassword(t){return z.post("/api/user/change-password",t)},async getUsers(){return z.get("/api/users")},async createUser(t){return z.post("/api/users",t)},async adminUpdateUser(t){return z.put("/api/users",t)},async deleteUser(t){return z.delete(`/api/users?id=${t}`)}};var K=[{code:"en",name:"English",flag:"\uD83C\uDDFA\uD83C\uDDF8"},{code:"zh",name:"简体中文",flag:"\uD83C\uDDE8\uD83C\uDDF3"},{code:"hi",name:"हिन्दी",flag:"\uD83C\uDDEE\uD83C\uDDF3"},{code:"es",name:"Español",flag:"\uD83C\uDDEA\uD83C\uDDF8"},{code:"ar",name:"العربية",flag:"\uD83C\uDDF8\uD83C\uDDE6"},{code:"fr",name:"Français",flag:"\uD83C\uDDEB\uD83C\uDDF7"},{code:"bn",name:"Bengali",flag:"\uD83C\uDDE7\uD83C\uDDE9"},{code:"pt",name:"Português",flag:"\uD83C\uDDF5\uD83C\uDDF9"},{code:"ru",name:"Русский",flag:"\uD83C\uDDF7\uD83C\uDDFA"},{code:"de",name:"Deutsch",flag:"\uD83C\uDDE9\uD83C\uDDEA"},{code:"ja",name:"日本語",flag:"\uD83C\uDDEF\uD83C\uDDF5"},{code:"it",name:"Italiano",flag:"\uD83C\uDDEE\uD83C\uDDF9"},{code:"tr",name:"Turkish",flag:"\uD83C\uDDF9\uD83C\uDDF7"},{code:"ko",name:"한국어",flag:"\uD83C\uDDF0\uD83C\uDDF7"},{code:"id",name:"Indonesian",flag:"\uD83C\uDDEE\uD83C\uDDE9"},{code:"pl",name:"Polski",flag:"\uD83C\uDDF5\uD83C\uDDF1"},{code:"ur",name:"Urdu",flag:"\uD83C\uDDF5\uD83C\uDDF0"},{code:"nl",name:"Nederlands",flag:"\uD83C\uDDF3\uD83C\uDDF1"},{code:"fa",name:"Persian",flag:"\uD83C\uDDEE\uD83C\uDDF7"},{code:"el",name:"Greek",flag:"\uD83C\uDDEC\uD83C\uDDF7"}];class O{currentLanguage="en";cache=new Map;listeners=[];static instance;initialized;constructor(){this.initialized=this.init()}async init(){await this.loadLocale("en");let t=localStorage.getItem("csh_lang"),o=navigator.language.split("-")[0],r="en";if(t&&K.find((e)=>e.code===t))r=t;else if(K.find((e)=>e.code===o))r=o;if(r!=="en")await this.loadLocale(r);this.currentLanguage=r,this.notifyListeners()}static getInstance(){if(!O.instance)O.instance=new O;return O.instance}getLocale(){return{...K.find((o)=>o.code===this.currentLanguage)||K[0],translations:this.cache.get(this.currentLanguage)||{}}}getAvailableLocales(){return K}async loadLocale(t){if(this.cache.has(t))return;try{let o=await fetch(`/locales/${t}.json?v=${new Date().getTime()}`);if(!o.ok)throw Error(`Failed to load locale ${t}`);let r=await o.json();this.cache.set(t,r)}catch(o){console.error(o)}}async setLanguage(t){if(K.find((o)=>o.code===t))await this.loadLocale(t),this.currentLanguage=t,localStorage.setItem("csh_lang",t),this.notifyListeners();else console.warn(`[I18n] Language ${t} not supported`)}t(t,o){let r=this.cache.get(this.currentLanguage),e=this.cache.get("en"),i=r?.[t];if(!i&&e)i=e[t];if(!i)return t;if(o)Object.keys(o).forEach((n)=>{i=i.replace(`{${n}}`,o[n])});return i}subscribe(t){return this.listeners.push(t),t(this.getLocale()),()=>{this.listeners=this.listeners.filter((o)=>o!==t)}}notifyListeners(){let t=this.getLocale();this.listeners.forEach((o)=>o(t))}async ensureInitialized(){return this.initialized}}var a=O.getInstance();class Ct{user=null;listeners=[];constructor(){this.loadFromStorage()}loadFromStorage(){let t=localStorage.getItem("csh_user_cache");if(t)try{this.user=JSON.parse(t),this.applyAesthetics(),this.notify()}catch(o){console.error("Failed to parse user cache",o)}}saveToStorage(){if(this.user)localStorage.setItem("csh_user_cache",JSON.stringify(this.user))}subscribe(t){if(this.listeners.push(t),this.user)t(this.user);return()=>{this.listeners=this.listeners.filter((o)=>o!==t)}}notify(){this.listeners.forEach((t)=>t(this.user)),this.saveToStorage()}setUser(t){if(!t)return;let o={grid_columns_pc:9,grid_columns_tablet:4,grid_columns_mobile:2};this.user={...t,preferences:{accent_color:t.accent_color||"blue",language:t.language||"en",theme:t.theme,grid_columns_pc:t.grid_columns_pc||o.grid_columns_pc,grid_columns_tablet:t.grid_columns_tablet||o.grid_columns_tablet,grid_columns_mobile:t.grid_columns_mobile||o.grid_columns_mobile,project_name:t.project_name||"CSH Dashboard"},project_name:t.project_name||"CSH Dashboard"},this.applyAesthetics(),this.notify()}applyAesthetics(){if(!this.user||!this.user.preferences)return;let t=this.user.preferences,o=document.documentElement;if(t.grid_columns_pc)o.style.setProperty("--grid-columns-pc",String(t.grid_columns_pc));if(t.grid_columns_tablet)o.style.setProperty("--grid-columns-tablet",String(t.grid_columns_tablet));if(t.grid_columns_mobile)o.style.setProperty("--grid-columns-mobile",String(t.grid_columns_mobile));if(t.accent_color){let r=this.getAccentHex(t.accent_color);o.style.setProperty("--accent",r)}if(t.theme==="light")o.classList.add("light-theme");else o.classList.remove("light-theme")}getAccentHex(t){if(t.startsWith("#"))return t;return{blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"}[t]||"#0078D4"}async updatePreferences(t){if(!this.user||!this.user.preferences)return;let o={...this.user.preferences};if(this.user.preferences={...this.user.preferences,...t},t.accent_color)this.user.accent_color=t.accent_color;if(t.language)this.user.language=t.language;if(t.project_name)this.user.project_name=t.project_name;if(t.theme)this.user.preferences.theme=t.theme;this.applyAesthetics(),this.notify();try{if(await A.updatePreferences({accent_color:this.user.accent_color,language:this.user.language,theme:this.user.preferences.theme,grid_columns_pc:this.user.preferences.grid_columns_pc,grid_columns_tablet:this.user.preferences.grid_columns_tablet,grid_columns_mobile:this.user.preferences.grid_columns_mobile,project_name:this.user.project_name}),window.notifier)window.notifier.show(a.t("general.success")||"Preferences saved")}catch(r){if(console.error("[UserStore] Failed to sync preferences, rolling back",r),this.user.preferences=o,this.applyAesthetics(),this.notify(),window.notifier)window.notifier.show("Failed to save settings","error")}}async updateProfile(t){if(!this.user)return;try{if(await A.updateProfile(t),this.user={...this.user,...t},this.notify(),window.notifier)window.notifier.show("Profile updated")}catch(o){if(console.error("[UserStore] Update profile failed",o),window.notifier)window.notifier.show("Failed to update profile","error")}}async changePassword(t){try{await A.changePassword(t)}catch(o){throw console.error("[UserStore] Change password failed",o),o}}getUser(){return this.user}async fetchUser(){try{let t=await A.getCurrentUser();this.setUser(t)}catch(t){if(console.error("[UserStore] Error fetching user",t),!this.user){if(window.notifier)window.notifier.show("Session expired or server unreachable","error")}}}}var k=new Ct;var F={async getItems(){return z.get("/api/dashboard")},async updateItem(t){let o={...t};if(t.parent_id===void 0&&"parent_id"in t)o.clear_parent=!0;return z.patch(`/api/dashboard/item/${t.id}`,o)},async createItem(t){return z.post("/api/dashboard/item",t)},async deleteItem(t){return z.delete(`/api/dashboard/item/${t}`)},async checkHealth(t){return z.get(`/api/dashboard/health?url=${encodeURIComponent(t)}`)}};var lt="kashboard-items",kt=[{id:1,type:"bookmark",x:1,y:1,w:1,h:1,content:{label:"Proxmox",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/proxmox.png",iconName:"proxmox"}},{id:2,type:"bookmark",x:2,y:1,w:1,h:1,content:{label:"TrueNAS",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/truenas.png",iconName:"truenas"}},{id:3,type:"bookmark",x:3,y:1,w:1,h:1,content:{label:"Cloudflare",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/cloudflare.png",iconName:"cloudflare"}},{id:4,type:"bookmark",x:1,y:2,w:1,h:1,content:{label:"GitHub",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/github.png",iconName:"github"}},{id:5,type:"bookmark",x:2,y:2,w:1,h:1,content:{label:"VS Code",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/vscode.png",iconName:"vscode"}},{id:6,type:"bookmark",x:3,y:2,w:1,h:1,content:{label:"Documentation",url:"#",icon:"https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/docs.png",iconName:"docs"}}];class Yt{state={isEditing:!1,items:[...kt],searchQuery:"",isOffline:!1,stats:null};listeners=[];constructor(){this.loadFromLocalStorage(),this.initSocket()}initSocket(){Promise.resolve().then(() => (Jt(),Mt)).then(({socketService:t})=>{t.subscribe((o)=>{this.state.stats={cpu_usage:o.cpu_usage,ram_usage:o.ram_usage,temperature:o.temperature},this.notify()})})}saveToLocalStorage(){try{if(this.state.items.filter((r)=>r.parent_id!==void 0).length>0);let o=JSON.stringify(this.state.items);localStorage.setItem(lt,o)}catch(t){console.error("[DashboardStore] Failed to save to localStorage",t)}}loadFromLocalStorage(){try{let t=localStorage.getItem(lt);if(t){let o=JSON.parse(t);if(Array.isArray(o)&&o.length>0)this.state.items=o}}catch(t){console.error("[DashboardStore] Failed to load from localStorage",t)}}subscribe(t){return this.listeners.push(t),this.ensureItemsIsArray(),t({...this.state,items:[...this.state.items]}),()=>{this.listeners=this.listeners.filter((o)=>o!==t)}}ensureItemsIsArray(){if(!Array.isArray(this.state.items))console.error("[DashboardStore] CRITICAL: items is not an array, resetting to empty array",typeof this.state.items),this.state.items=[]}notify(){this.ensureItemsIsArray();let t={...this.state,items:[...this.state.items]};this.listeners.forEach((o)=>o(t))}setEditMode(t){this.state.isEditing=t,this.notify()}toggleEditMode(){this.setEditMode(!this.state.isEditing)}setSearchQuery(t){this.state.searchQuery=t.toLowerCase().trim(),this.notify()}async fetchItems(){try{try{let t=await F.getItems();if(Array.isArray(t)&&t.length>0){let o=localStorage.getItem(lt);if(o){let r=JSON.parse(o);t.forEach((e)=>{if(e.parent_id===void 0){let i=r.find((n)=>n.id===e.id);if(i&&i.parent_id!==void 0)e.parent_id=i.parent_id}})}this.state.items=t,this.state.isOffline=!1,this.saveToLocalStorage()}else throw Error("Backend returned empty or invalid data")}catch(t){this.state.isOffline=!0;let o=localStorage.getItem(lt);if(o){let r=JSON.parse(o);if(Array.isArray(r)&&r.length>0)this.state.items=r;else this.state.items=[...kt],this.saveToLocalStorage()}else this.state.items=[...kt],this.saveToLocalStorage()}this.ensureItemsIsArray(),this.notify()}catch(t){console.error("[DashboardStore] Failed to fetch dashboard items",t),this.state.items=[]}}async updateItem(t){try{this.ensureItemsIsArray();let o=this.state.items.findIndex((e)=>e.id==t.id);if(o===-1){console.warn("[DashboardStore] Item not found for update:",t.id);return}let r={...this.state.items[o]};this.state.items[o]={...this.state.items[o],...t},this.saveToLocalStorage(),this.notify();try{await F.updateItem(t),this.state.isOffline=!1,this.notify()}catch(e){console.error("[DashboardStore] Failed to sync item update (offline?), keeping local state",e),this.state.isOffline=!0,this.saveToLocalStorage(),this.notify()}}catch(o){console.error("[DashboardStore] Error updating item",o)}}async resizeItem(t,o,r){let e=this.state.items.find((i)=>i.id===t);if(!e)return;if(console.log(`[DashboardStore] Resizing item ${t} to ${o}x${r}`),await this.updateItem({id:t,w:o,h:r}),e.type==="section")await this.reflowChildren(t,o)}async reflowChildren(t,o){Promise.resolve().then(() => (Z(),V)).then(async({collisionService:r})=>{let e=this.state.items.filter((n)=>n.parent_id===t).sort((n,s)=>n.y-s.y||n.x-s.x);if(e.length===0)return;console.log(`[DashboardStore] Reflowing ${e.length} children for parent ${t}`);let i=[];for(let n of e){let s=r.findAvailableSlot(n.w,n.h,i,o);if(i.push({x:s.x,y:s.y,w:n.w,h:n.h}),n.x!==s.x||n.y!==s.y)console.log(`[DashboardStore] Reflow moving child ${n.id} to ${s.x},${s.y}`),await this.updateItem({id:n.id,x:s.x,y:s.y})}})}async addItem(t){try{console.log("[DashboardStore] Adding item:",t),this.ensureItemsIsArray();try{let o={...t};if(o.type==="widget"&&!o.url)o.url="";let r=await F.createItem(o);this.state.isOffline=!1,this.state.items.push(r),console.log("[DashboardStore] Item added (Synced), new length:",this.state.items.length),this.saveToLocalStorage(),this.notify()}catch(o){console.error("[DashboardStore] Failed to add item to backend",o)}}catch(o){console.error("[DashboardStore] Error adding item",o)}}async deleteItem(t){try{this.ensureItemsIsArray();let o=this.state.items.findIndex((e)=>e.id==t);if(console.log("[DashboardStore] Deleting item",t,"Found index:",o),o===-1){console.warn("[DashboardStore] Item not found for deletion:",t);return}let r=this.state.items[o];this.state.items.splice(o,1),this.saveToLocalStorage(),this.notify();try{await F.deleteItem(t)}catch(e){console.error("[DashboardStore] Failed to delete item, rolling back",e),this.state.items.push(r),this.saveToLocalStorage(),this.notify()}}catch(o){console.error("[DashboardStore] Error deleting item",o)}}getState(){return this.ensureItemsIsArray(),{...this.state,items:[...this.state.items]}}}var x=new Yt;class Qt{interval=null;checkFrequency=300000;start(){if(this.interval)return;setTimeout(()=>this.checkAll(),2000),this.interval=window.setInterval(()=>{this.checkAll()},this.checkFrequency)}stop(){if(this.interval)clearInterval(this.interval),this.interval=null}async checkAll(){let o=x.getState().items.filter((r)=>{if(r.type!=="bookmark")return!1;let e=r.content;if(typeof e==="string")try{e=JSON.parse(e)}catch(i){return!1}return e&&e.statusCheck===!0});for(let r of o)this.checkItem(r)}async checkItem(t){let o=t.content;if(typeof o==="string")try{o=JSON.parse(o)}catch(e){return}let r=o.url;if(!r||r==="#"||r.startsWith("javascript:"))return;try{if((await F.checkHealth(r)).status==="up")this.updateUIStatus(t.id,"up");else this.updateUIStatus(t.id,"down")}catch(e){console.warn(`[StatusService] ${r} health check failed:`,e),this.updateUIStatus(t.id,"down")}}updateUIStatus(t,o){let r=document.querySelector("bookmark-grid");if(!r||!r.shadowRoot)return;let e=r.shadowRoot.querySelector(`.bookmark-grid__card[data-id="${t}"]`);if(!e)return;let i=e.querySelector(".status-indicator");if(!i)return;i.classList.remove("status-pending","status-up","status-down"),i.classList.add(`status-${o}`);let n=o==="up"?"Online":o==="down"?"Offline / Unreachable":"Checking...";i.setAttribute("title",n)}}var P=new Qt;class U{static STORAGE_KEY="kashboard_theme";static CLASS_NAME="dark-mode";static init(){let t=localStorage.getItem(this.STORAGE_KEY);if(t==="dark")this.enableDark();else if(t==="light")this.enableLight();else if(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)this.enableDark();else this.enableLight()}static enableDark(){document.documentElement.classList.add(this.CLASS_NAME),localStorage.setItem(this.STORAGE_KEY,"dark"),this.setCookie(this.STORAGE_KEY,"dark",365)}static enableLight(){document.documentElement.classList.remove(this.CLASS_NAME),localStorage.setItem(this.STORAGE_KEY,"light"),this.setCookie(this.STORAGE_KEY,"light",365)}static toggle(){if(document.documentElement.classList.contains(this.CLASS_NAME))this.enableLight();else this.enableDark()}static isDark(){return document.documentElement.classList.contains(this.CLASS_NAME)}static setCookie(t,o,r){let e="";if(r){let i=new Date;i.setTime(i.getTime()+r*24*60*60*1000),e="; expires="+i.toUTCString()}document.cookie=t+"="+(o||"")+e+"; path=/"}}var Ot=()=>`
    <div class="paper">
        <slot></slot>
    </div>
`;var Zt=`:host {
...
.paper {
    ...
    height: 100%;
}`;class Ut extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            <style>${Zt}</style>
            ${Ot()}
        `}}if(!customElements.get("app-paper"))customElements.define("app-paper",Ut);var Xt=`:host {
...
.avatar__initials {
    user-select: none;
}`;class Wt extends HTMLElement{static get observedAttributes(){return["src","alt","initials"]}constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render()}attributeChangedCallback(t,o,r){if(o!==r)this.render()}render(){let t=this.getAttribute("src"),o=this.getAttribute("initials")||"??",r=this.getAttribute("alt")||"User Avatar";this.shadowRoot.innerHTML=`
            <style>${Pt}</style>
            ${Vt({src:t||void 0,initials:o,alt:r})}
        `}}if(!customElements.get("app-avatar"))customElements.define("app-avatar",Wt);var St=(t)=>`
...
.settings-content__danger-title {
    ...
    align-items: center;
    gap: 8px;
}`;class ao extends HTMLElement{prefs;users=[];static get observedAttributes(){return["section"]}constructor(){super();this.attachShadow({mode:"open"}),this.prefs={accent_color:"#0078D4",language:"en",grid_columns_pc:9,grid_columns_tablet:4,grid_columns_mobile:2}}connectedCallback(){if(this.fetchPrefs(),this.getAttribute("section")==="users")this.fetchUsers();this.render()}async fetchPrefs(){let t=k.getUser();if(t&&t.preferences)this.prefs={...t.preferences,project_name:t.project_name||t.preferences.project_name||"Kashboard"},this.render()}async fetchUsers(){try{this.users=await A.getUsers(),this.render()}catch(t){console.error("Failed to fetch users",t)}}attributeChangedCallback(t,o,r){if(t==="section"&&o!==r){if(r==="users")this.fetchUsers();if(r==="about")this.checkForUpdates();this.render()}}async savePrefs(t){if(this.prefs={...this.prefs,...t},t.accent_color)this.applyAccent(t.accent_color);if(t.language)a.setLanguage(t.language);if(t.theme)if(t.theme==="dark")U.enableDark();else U.enableLight();await k.updatePreferences(t),this.render()}applyAccent(t){if(t&&t.startsWith("#")){document.documentElement.style.setProperty("--accent",t);return}let r={blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"}[t]||"#0078D4";document.documentElement.style.setProperty("--accent",r)}updateGridPref(t,o){let r=this.shadowRoot.getElementById(`val-${t}`);if(r)r.textContent=o;let e={grid_columns_pc:"--grid-columns-pc",grid_columns_tablet:"--grid-columns-tablet",grid_columns_mobile:"--grid-columns-mobile"};if(e[t])document.documentElement.style.setProperty(e[t],o)}commitGridPref(t,o){k.updatePreferences({[t]:parseInt(o)})}async updateUsername(t){let o=k.getUser();if(!o)return;if(await k.updateProfile({username:t,avatar_url:this.prefs.avatar_url||o.avatar_url}),window.notifier)window.notifier.show(a.t("notifier.username_updated"))}async updatePassword(){let t=this.shadowRoot.getElementById("current-password")?.value,o=this.shadowRoot.getElementById("new-password")?.value,r=this.shadowRoot.getElementById("confirm-password")?.value;if(!t){if(window.notifier)window.notifier.show(a.t("notifier.password_required"),"error");return}if(o!==r){if(window.notifier)window.notifier.show(a.t("notifier.password_mismatch"),"error");return}if(!o){if(window.notifier)window.notifier.show(a.t("notifier.password_empty"),"error");return}try{if(await k.changePassword({current_password:t,new_password:o}),window.notifier)window.notifier.show(a.t("notifier.password_changed"));this.shadowRoot.getElementById("current-password").value="",this.shadowRoot.getElementById("new-password").value="",this.shadowRoot.getElementById("confirm-password").value=""}catch(e){if(window.notifier)window.notifier.show(a.t("notifier.password_incorrect"),"error")}}async handleAvatarChange(t){let o=t.target.files?.[0];if(!o)return;let r=new FileReader;r.onload=async(e)=>{let i=e.target?.result,n=k.getUser();if(!n)return;if(this.prefs.avatar_url=i,await k.updateProfile({username:n.username,avatar_url:i}),this.render(),window.notifier)window.notifier.show(a.t("notifier.avatar_updated"))},r.readAsDataURL(o)}openAddUserModal(){let t=this.shadowRoot.getElementById("add-user-modal");if(t)t.showModal()}async createUser(){let t=this.shadowRoot.getElementById("new-user-username").value,o=this.shadowRoot.getElementById("new-user-password").value,r=this.shadowRoot.getElementById("new-user-role").value;if(!t||!o){if(window.notifier)window.notifier.show(a.t("notifier.fields_required"),"error");return}try{if(await A.createUser({username:t,password:o,role:r}),window.notifier)window.notifier.show(a.t("notifier.user_created"));let e=this.shadowRoot.getElementById("add-user-modal");if(e)e.close();this.fetchUsers()}catch(e){if(window.notifier)window.notifier.show(a.t("notifier.user_create_error"),"error")}}openEditUserModal(t,o,r){let e=this.shadowRoot.getElementById("edit-user-modal");if(e)this.shadowRoot.getElementById("edit-user-id").value=t.toString(),this.shadowRoot.getElementById("edit-user-username").value=o,this.shadowRoot.getElementById("edit-user-role").value=r,this.shadowRoot.getElementById("edit-user-password").value="",e.showModal()}async updateAdminUser(){let t=parseInt(this.shadowRoot.getElementById("edit-user-id").value),o=this.shadowRoot.getElementById("edit-user-username").value,r=this.shadowRoot.getElementById("edit-user-password").value,e=this.shadowRoot.getElementById("edit-user-role").value;if(!o){if(window.notifier)window.notifier.show("Username required","error");return}try{if(await A.adminUpdateUser({id:t,username:o,role:e,password:r||void 0}),window.notifier)window.notifier.show(a.t("notifier.user_updated"));let i=this.shadowRoot.getElementById("edit-user-modal");if(i)i.close();this.fetchUsers()}catch(i){if(window.notifier)window.notifier.show(a.t("notifier.user_update_error"),"error")}}async deleteUser(t){let o=document.querySelector("confirmation-modal");if(o){if(!await o.confirm(a.t("general.delete"),a.t("notifier.user_delete_confirm")))return}try{if(await A.deleteUser(t),window.notifier)window.notifier.show(a.t("notifier.user_deleted"));this.fetchUsers()}catch(r){if(window.notifier)window.notifier.show(a.t("notifier.user_delete_error"),"error")}}getContent(t){let o=k.getUser()||{username:"Guest",initials:"??",role:"View Only",avatar_url:"",accent_color:"#0078D4",language:"en",preferences:{}};switch(t){case"account":return St(o);case"theme":{let r={blue:"#228be6",indigo:"#4c6ef5",cyan:"#15aabf",teal:"#12b886",orange:"#fd7e14",red:"#fa5252",grape:"#be4bdb"},e=Object.keys(r);return It(this.prefs,r,e)}case"personalization":{let r=[{label:a.t("settings.grid_pc"),key:"grid_columns_pc",min:4,max:12},{label:a.t("settings.grid_tablet"),key:"grid_columns_tablet",min:2,max:6},{label:a.t("settings.grid_mobile"),key:"grid_columns_mobile",min:1,max:3}];return to(this.prefs,r)}case"advanced":return ro();case"users":return oo(this.users);case"about":return eo(this.version,this.updateInfo);default:return`<div class="bento-card"><h3>${t}</h3><p class="settings-content__text-dim">${a.t("settings.default_module_desc")}</p></div>`}}version="v0.0.1";updateInfo=null;async checkForUpdates(){try{let t=await fetch("/api/system/update/check");if(t.ok)this.updateInfo=await t.json(),this.version=this.updateInfo.current_version,this.render()}catch(t){console.error("Check update failed",t)}}async performUpdate(t){let o=document.querySelector("confirmation-modal");if(o){if(!await o.confirm(a.t("settings.update_available"),a.t("notifier.update_start_confirm")))return}let r=this.shadowRoot.getElementById("btn-update-now"),e=this.shadowRoot.getElementById("update-status");if(r)r.loading=!0;if(e)e.style.display="block",e.textContent=a.t("notifier.update_downloading");try{let i=await fetch("/api/system/update/perform",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({asset_url:t})});if(i.ok){if(e)e.textContent=a.t("notifier.update_verified");setTimeout(()=>{window.location.reload()},5000)}else{let n=await i.text();if(e)e.style.color="#fa5252",e.textContent=a.t("notifier.update_failed")+n;if(r)r.loading=!1}}catch(i){if(console.error("Update failed",i),e)e.style.color="#fa5252",e.textContent=a.t("notifier.update_error");if(r)r.loading=!1}}downloadBackup(){window.location.href="/api/system/backup"}async restoreBackup(t){if(!t)return;let o=document.querySelector("confirmation-modal");if(o){if(!await o.confirm(a.t("general.restore"),a.t("notifier.restore_confirm")))return}let r=new FormData;r.append("backup_file",t);try{if((await fetch("/api/system/restore",{method:"POST",body:r})).ok){if(window.notifier)window.notifier.show(a.t("notifier.restore_success"));setTimeout(()=>window.location.reload(),2000)}else if(window.notifier)window.notifier.show(a.t("notifier.restore_failed"),"error")}catch(e){if(console.error("Restore error",e),window.notifier)window.notifier.show(a.t("notifier.restore_failed"),"error")}}openResetModal(){let t=this.shadowRoot.getElementById("reset-confirm-modal"),o=this.shadowRoot.getElementById("reset-confirm-input");if(t){if(o)o.value="";t.showModal()}}async executeFactoryReset(){let t=this.shadowRoot.getElementById("reset-confirm-input");if(!t||t.value.trim()!=="delete"){if(window.notifier)window.notifier.show(a.t("notifier.reset_confirm_text"),"error");t.focus();return}try{if((await fetch("/api/system/reset",{method:"POST"})).ok)window.location.href="/setup";else if(window.notifier)window.notifier.show(a.t("notifier.reset_failed"),"error")}catch(o){if(console.error("Reset error",o),window.notifier)window.notifier.show(a.t("notifier.reset_error"),"error")}}render(){this.shadowRoot.innerHTML=`
            <style>${io}</style>
            <div class="fade-in">
                ${this.getContent(this.getAttribute("section")||"account")}
            </div>
        `,this.shadowRoot.querySelectorAll(".settings-content__checkbox").forEach((t)=>{t.addEventListener("click",()=>t.classList.toggle("settings-content__checkbox--checked"))})}}if(!customElements.get("settings-content"))customElements.define("settings-content",ao);var no=({user:t,isOpen:o,selectedSection:r})=>`
...
(max-width: 1024px) {
...
}`;class bo extends HTMLElement{dropdownOpen;constructor(){super();this.attachShadow({mode:"open"}),this.dropdownOpen=!1}connectedCallback(){this.render(),this.setupListeners()}toggleDropdown(t){this.dropdownOpen=typeof t==="boolean"?t:!this.dropdownOpen,this.render()}setupListeners(){this.shadowRoot.addEventListener("click",(t)=>{let o=t.target,r=o.closest(".header__btn-changelog");if(r)console.log("Changelog closed"),r.style.display="none";if(o.closest("#profile-trigger"))t.stopPropagation(),this.toggleDropdown()}),window.addEventListener("click",()=>{if(this.dropdownOpen)this.toggleDropdown(!1)})}render(){let t=this.getAttribute("title")||"Task";this.shadowRoot.innerHTML=`
            <style>${ho}</style>
            ${xo({title:t,dropdownOpen:this.dropdownOpen})}
        `}}if(!customElements.get("app-header"))customElements.define("app-header",bo);var vo=({bookmarks:t,isEditing:o,isSearching:r,isTouchDevice:e})=>{let i=Array.isArray(t)?t:[],n=(c)=>i.filter((p)=>p.parent_id===c);return`
    ${(r||e?i:i.filter((c)=>!c.parent_id)).map((c)=>{let p={};try{p=typeof c.content==="string"?JSON.parse(c.content):c.content}catch(g){console.error("Failed to parse content for item",c.id,g)}if(c.type==="section"){let g=n(c.id);return`
            <div class="bookmark-grid__section"
               ...
               `:""}
            </div>`}return _o(c,p,o)}).join("")}

    <div id="ghost-element" class="bookmark-grid__ghost" style="display: none;"></div>
`};function _o(t,o,r){if(t.type==="widget"){let l=o.widgetId,p={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry"}[l]||"div",g=(o.text||"").replace(/"/g,"&quot;");return`
    ...
    `}function yr(t,o,r=!1){return t.map((e)=>{let i={};try{i=typeof e.content==="string"?JSON.parse(e.content):e.content}catch(n){console.error("Failed to parse content for item (nested)",e.id,n)}return _o(e,i,o)}).join("")}Z();class mo extends HTMLElement{timer;timeEl=null;dateEl=null;_unsubscribe=null;_unsubscribeI18n;constructor(){super();this.attachShadow({mode:"open"})}isEditing=!1;configMode=!1;_config={timezone:"local",hour12:!1,showDate:!0};_itemId=0;static get observedAttributes(){return["item-id","content","mode"]}attributeChangedCallback(t,o,r){if(t==="item-id")this._itemId=parseInt(r);if(t==="content")try{let e=typeof r==="string"?JSON.parse(r):r;if(e&&typeof e==="object")this._config={...this._config,...e},this.updateTime()}catch(e){}}connectedCallback(){this.render(),this.updateTime(),this.timer=setInterval(()=>{this.updateTime()},1000),this._unsubscribe=x.subscribe((t)=>{if(this.isEditing!==t.isEditing)this.isEditing=t.isEditing,this.render();if(this._itemId){let o=t.items.find((r)=>r.id===this._itemId);if(o&&o.content)try{let r=typeof o.content==="string"?JSON.parse(o.content):o.content;if(r.widgetId==="clock")this._config={...this._config,...r},this.updateTime()}catch(r){}}}),this._unsubscribeI18n=a.subscribe(()=>{this.updateTime()})}disconnectedCallback(){if(this._unsubscribe)this._unsubscribe();if(this._unsubscribeI18n)this._unsubscribeI18n();if(this.timer)clearInterval(this.timer)}updateTime(){if(!this.timeEl||!this.dateEl)return;let t=new Date,o={hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:this._config.hour12},r=void 0;if(this._config.timezone&&this._config.timezone!=="local")r=this._config.timezone;let e=a.getLocale().code;try{let s=new Intl.DateTimeFormat(e,{...o,timeZone:r}).formatToParts(t).map((l)=>{if(l.type==="dayPeriod")return`<span class="ampm">${l.value.toUpperCase().replace(/\./g,"").trim()}</span>`;return l.value}).join("");this.timeEl.innerHTML=s}catch(i){this.timeEl.textContent=t.toLocaleTimeString()}if(this._config.showDate){let i={weekday:"long",day:"numeric",month:"long",timeZone:r};this.dateEl.textContent=t.toLocaleDateString(e,i),this.dateEl.style.display="block"}else this.dateEl.style.display="none"}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
            ...
            <div class="time">--:--:--</div>
            <div class="date">-- --</div>
        `,this.timeEl=this.shadowRoot.querySelector(".time"),this.dateEl=this.shadowRoot.querySelector(".date")}}customElements.define("widget-clock",mo);var ct=globalThis,dt=ct.ShadowRoot&&(ct.ShadyCSS===void 0||ct.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,wt=Symbol(),fo=new WeakMap;class pt{constructor(t,o,r){if(this._$cssResult$=!0,r!==wt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=o}get styleSheet(){let t=this.o,o=this.t;if(dt&&t===void 0){let r=o!==void 0&&o.length===1;r&&(t=fo.get(o)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&fo.set(o,t))}return t}toString(){return this.cssText}}var uo=(t)=>new pt(typeof t=="string"?t:t+"",void 0,wt),$t=(t,...o)=>{let r=t.length===1?t[0]:o.reduce((e,i,n)=>e+((s)=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[n+1],t[0]);return new pt(r,t,wt)},yo=(t,o)=>{if(dt)t.adoptedStyleSheets=o.map((r)=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(let r of o){let e=document.createElement("style"),i=ct.litNonce;i!==void 0&&e.setAttribute("nonce",i),e.textContent=r.cssText,t.appendChild(e)}},zt=dt?(t)=>t:(t)=>t instanceof CSSStyleSheet?((o)=>{let r="";for(let e of o.cssRules)r+=e.cssText;return uo(r)})(t):t;var{is:kr,defineProperty:wr,getOwnPropertyDescriptor:$r,getOwnPropertyNames:zr,getOwnPropertySymbols:Tr,getPrototypeOf:jr}=Object,gt=globalThis,ko=gt.trustedTypes,Lr=ko?ko.emptyScript:"",Ar=gt.reactiveElementPolyfillSupport,W=(t,o)=>t,S={toAttribute(t,o){switch(o){case Boolean:t=t?Lr:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,o){let r=t;switch(o){case Boolean:r=t!==null;break;case Number:r=t===null?null:Number(t);break;case Object:case Array:try{r=JSON.parse(t)}catch(e){r=null}}return r}},xt=(t,o)=>!kr(t,o),wo={attribute:!0,type:String,converter:S,reflect:!1,useDefault:!1,hasChanged:xt};Symbol.metadata??=Symbol("metadata"),gt.litPropertyMetadata??=new WeakMap;class B extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,o=wo){if(o.state&&(o.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((o=Object.create(o)).wrapped=!0),this.elementProperties.set(t,o),!o.noAccessor){let r=Symbol(),e=this.getPropertyDescriptor(t,r,o);e!==void 0&&wr(this.prototype,t,e)}}static getPropertyDescriptor(t,o,r){let{get:e,set:i}=$r(this.prototype,t)??{get(){return this[o]},set(n){this[o]=n}};return{get:e,set(n){let s=e?.call(this);i?.call(this,n),this.requestUpdate(t,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??wo}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;let t=jr(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){let o=this.properties,r=[...zr(o),...Tr(o)];for(let e of r)this.createProperty(e,o[e])}let t=this[Symbol.metadata];if(t!==null){let o=litPropertyMetadata.get(t);if(o!==void 0)for(let[r,e]of o)this.elementProperties.set(r,e)}this._$Eh=new Map;for(let[o,r]of this.elementProperties){let e=this._$Eu(o,r);e!==void 0&&this._$Eh.set(e,o)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let o=[];if(Array.isArray(t)){let r=new Set(t.flat(1/0).reverse());for(let e of r)o.unshift(zt(e))}else t!==void 0&&o.push(zt(t));return o}static _$Eu(t,o){let r=o.attribute;return r===!1?void 0:typeof r=="string"?r:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t)=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t)=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,o=this.constructor.elementProperties;for(let r of o.keys())this.hasOwnProperty(r)&&(t.set(r,this[r]),delete this[r]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return yo(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t)=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t)=>t.hostDisconnected?.())}attributeChangedCallback(t,o,r){this._$AK(t,r)}_$ET(t,o){let r=this.constructor.elementProperties.get(t),e=this.constructor._$Eu(t,r);if(e!==void 0&&r.reflect===!0){let i=(r.converter?.toAttribute!==void 0?r.converter:S).toAttribute(o,r.type);this._$Em=t,i==null?this.removeAttribute(e):this.setAttribute(e,i),this._$Em=null}}_$AK(t,o){let r=this.constructor,e=r._$Eh.get(t);if(e!==void 0&&this._$Em!==e){let i=r.getPropertyOptions(e),n=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:S;this._$Em=e;let s=n.fromAttribute(o,i.type);this[e]=s??this._$Ej?.get(e)??s,this._$Em=null}}requestUpdate(t,o,r,e=!1,i){if(t!==void 0){let n=this.constructor;if(e===!1&&(i=this[t]),r??=n.getPropertyOptions(t),!((r.hasChanged??xt)(i,o)||r.useDefault&&r.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,r))))return;this.C(t,o,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,o,{useDefault:r,reflect:e,wrapped:i},n){r&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??o??this[t]),i!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||r||(o=void 0),this._$AL.set(t,o)),e===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(o){Promise.reject(o)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,i]of this._$Ep)this[e]=i;this._$Ep=void 0}let r=this.constructor.elementProperties;if(r.size>0)for(let[e,i]of r){let{wrapped:n}=i,s=this[e];n!==!0||this._$AL.has(e)||s===void 0||this.C(e,void 0,i,s)}}let t=!1,o=this._$AL;try{t=this.shouldUpdate(o),t?(this.willUpdate(o),this._$EO?.forEach((r)=>r.hostUpdate?.()),this.update(o)):this._$EM()}catch(r){throw t=!1,this._$EM(),r}t&&this._$AE(o)}willUpdate(t){}_$AE(t){this._$EO?.forEach((o)=>o.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((o)=>this._$ET(o,this[o])),this._$EM()}updated(t){}firstUpdated(t){}}B.elementStyles=[],B.shadowRootOptions={mode:"open"},B[W("elementProperties")]=new Map,B[W("finalized")]=new Map,Ar?.({ReactiveElement:B}),(gt.reactiveElementVersions??=[]).push("2.1.2");var Tt=globalThis,$o=(t)=>t,ht=Tt.trustedTypes,zo=ht?ht.createPolicy("lit-html",{createHTML:(t)=>t}):void 0;var G=`lit$${Math.random().toFixed(9).slice(2)}$`,Ho="?"+G,Er=`<${Ho}>`,q=document,tt=()=>q.createComment(""),ot=(t)=>t===null||typeof t!="object"&&typeof t!="function",jt=Array.isArray,Hr=(t)=>jt(t)||typeof t?.[Symbol.iterator]=="function";var I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,To=/-->/g,jo=/>/g,N=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Lo=/'/g,Ao=/"/g,Fo=/^(?:script|style|textarea|title)$/i,Lt=(t)=>(o,...r)=>({_$litType$:t,strings:o,values:r}),v=Lt(1),Ie=Lt(2),ti=Lt(3),M=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Eo=new WeakMap,C=q.createTreeWalker(q,129);function Bo(t,o){if(!jt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return zo!==void 0?zo.createHTML(o):o}var Fr=(t,o)=>{let r=t.length-1,e=[],i,n=o===2?"<svg>":o===3?"<math>":"",s=I;for(let l=0;l<r;l++){let c=t[l],p,d,g=-1,h=0;for(;h<c.length&&(s.lastIndex=h,d=s.exec(c),d!==null);)h=s.lastIndex,s===I?d[1]==="!--"?s=To:d[1]!==void 0?s=jo:d[2]!==void 0?(Fo.test(d[2])&&(i=RegExp("</"+d[2],"g")),s=N):d[3]!==void 0&&(s=N):s===N?d[0]===">"?(s=i??I,g=-1):d[1]===void 0?g=-2:(g=s.lastIndex-d[2].length,p=d[1],s=d[3]===void 0?N:d[3]==='"'?Ao:Lo):s===Ao||s===Lo?s=N:s===To||s===jo?s=I:(s=N,i=void 0);let b=s===N&&t[l+1].startsWith("/>")?" ":"";n+=s===I?c+Er:g>=0?(e.push(p),c.slice(0,g)+"$lit$"+c.slice(g)+G+b):c+G+(g===-2?l:b)}return[Bo(t,n+(t[r]||"<?>")+(o===2?"</svg>":o===3?"</math>":"")),e]};class rt{constructor({strings:t,_$litType$:o},r){let e;this.parts=[];let i=0,n=0,s=t.length-1,l=this.parts,[c,p]=Fr(t,o);if(this.el=rt.createElement(c,r),C.currentNode=this.el.content,o===2||o===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(e=C.nextNode())!==null&&l.length<s;){if(e.nodeType===1){if(e.hasAttributes())for(let d of e.getAttributeNames())if(d.endsWith("$lit$")){let g=p[n++],h=e.getAttribute(d).split(G),b=/([.?@])?(.*)/.exec(g);l.push({type:1,index:i,name:b[2],strings:h,ctor:b[1]==="."?Ro:b[1]==="?"?Ko:b[1]==="@"?No:it}),e.removeAttribute(d)}else d.startsWith(G)&&(l.push({type:6,index:i}),e.removeAttribute(d));if(Fo.test(e.tagName)){let d=e.textContent.split(G),g=d.length-1;if(g>0){e.textContent=ht?ht.emptyScript:"";for(let h=0;h<g;h++)e.append(d[h],tt()),C.nextNode(),l.push({type:2,index:++i});e.append(d[g],tt())}}}else if(e.nodeType===8)if(e.data===Ho)l.push({type:2,index:i});else{let d=-1;for(;(d=e.data.indexOf(G,d+1))!==-1;)l.push({type:7,index:i}),d+=G.length-1}i++}}static createElement(t,o){let r=q.createElement("template");return r.innerHTML=t,r}}function X(t,o,r=t,e){if(o===M)return o;let i=e!==void 0?r._$Co?.[e]:r._$Cl,n=ot(o)?void 0:o._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(t),i._$AT(t,r,e)),e!==void 0?(r._$Co??=[])[e]=i:r._$Cl=i),i!==void 0&&(o=X(t,i._$AS(t,o.values),i,e)),o}class Go{constructor(t,o){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=o}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:o},parts:r}=this._$AD,e=(t?.creationScope??q).importNode(o,!0);C.currentNode=e;let i=C.nextNode(),n=0,s=0,l=r[0];for(;l!==void 0;){if(n===l.index){let c;l.type===2?c=new et(i,i.nextSibling,this,t):l.type===1?c=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(c=new Co(i,this,t)),this._$AV.push(c),l=r[++s]}n!==l?.index&&(i=C.nextNode(),n++)}return C.currentNode=q,e}p(t){let o=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,o),o+=r.strings.length-2):r._$AI(t[o])),o++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,o,r,e){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=t,this._$AB=o,this._$AM=r,this.options=e,this._$Cv=e?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,o=this._$AM;return o!==void 0&&t?.nodeType===11&&(t=o.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,o=this){t=X(this,t,o),ot(t)?t===y||t==null||t===""?(this._$AH!==y&&this._$AR(),this._$AH=y):t!==this._$AH&&t!==M&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Hr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==y&&ot(this._$AH)?this._$AA.nextSibling.data=t:this.T(q.createTextNode(t)),this._$AH=t}$(t){let{values:o,_$litType$:r}=t,e=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=rt.createElement(Bo(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===e)this._$AH.p(o);else{let i=new Go(e,this),n=i.u(this.options);i.p(o),this.T(n),this._$AH=i}}_$AC(t){let o=Eo.get(t.strings);return o===void 0&&Eo.set(t.strings,o=new rt(t)),o}k(t){jt(this._$AH)||(this._$AH=[],this._$AR());let o=this._$AH,r,e=0;for(let i of t)e===o.length?o.push(r=new et(this.O(tt()),this.O(tt()),this,this.options)):r=o[e],r._$AI(i),e++;e<o.length&&(this._$AR(r&&r._$AB.nextSibling,e),o.length=e)}_$AR(t=this._$AA.nextSibling,o){for(this._$AP?.(!1,!0,o);t!==this._$AB;){let r=$o(t).nextSibling;$o(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class it{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,o,r,e,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=t,this.name=o,this._$AM=e,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=y}_$AI(t,o=this,r,e){let i=this.strings,n=!1;if(i===void 0)t=X(this,t,o,0),n=!ot(t)||t!==this._$AH&&t!==M,n&&(this._$AH=t);else{let s=t,l,c;for(t=i[0],l=0;l<i.length-1;l++)c=X(this,s[r+l],o,l),c===M&&(c=this._$AH[l]),n||=!ot(c)||c!==this._$AH[l],c===y?t=y:t!==y&&(t+=(c??"")+i[l+1]),this._$AH[l]=c}n&&!e&&this.j(t)}j(t){t===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ro extends it{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===y?void 0:t}}class Ko extends it{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==y)}}class No extends it{constructor(t,o,r,e,i){super(t,o,r,e,i),this.type=5}_$AI(t,o=this){if((t=X(this,t,o,0)??y)===M)return;let r=this._$AH,e=t===y&&r!==y||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,i=t!==y&&(r===y||e);e&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Co{constructor(t,o,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=o,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){X(this,t)}}var Br=Tt.litHtmlPolyfillSupport;Br?.(rt,et),(Tt.litHtmlVersions??=[]).push("3.3.2");var qo=(t,o,r)=>{let e=r?.renderBefore??o,i=e._$litPart$;if(i===void 0){let n=r?.renderBefore??null;e._$litPart$=i=new et(o.insertBefore(tt(),n),n,void 0,r??{})}return i._$AI(t),i};var At=globalThis;class J extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=qo(o,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}}J._$litElement$=!0,J.finalized=!0,At.litElementHydrateSupport?.({LitElement:J});var Gr=At.litElementPolyfillSupport;Gr?.({LitElement:J});(At.litElementVersions??=[]).push("4.2.2");var Mo=(t)=>(o,r)=>{r!==void 0?r.addInitializer(()=>{customElements.define(t,o)}):customElements.define(t,o)};var Rr={attribute:!0,type:String,converter:S,reflect:!1,hasChanged:xt},Kr=(t=Rr,o,r)=>{let{kind:e,metadata:i}=r,n=globalThis.litPropertyMetadata.get(i);if(n===void 0&&globalThis.litPropertyMetadata.set(i,n=new Map),e==="setter"&&((t=Object.create(t)).wrapped=!0),n.set(r.name,t),e==="accessor"){let{name:s}=r;return{set(l){let c=o.get.call(this);o.set.call(this,l),this.requestUpdate(s,c,t,!0,l)},init(l){return l!==void 0&&this.C(s,void 0,t,l),l}}}if(e==="setter"){let{name:s}=r;return function(l){let c=this[s];o.call(this,l),this.requestUpdate(s,c,t,!0,l)}}throw Error("Unsupported decorator location: "+e)};function at(t){return(o,r)=>typeof r=="object"?Kr(t,o,r):((e,i,n)=>{let s=i.hasOwnProperty(n);return i.constructor.createProperty(n,e),s?Object.getOwnPropertyDescriptor(i,n):void 0})(t,o,r)}function Et(t){return at({...t,state:!0,attribute:!1})}var Y=(t,o,r)=>(r.configurable=!0,r.enumerable=!0,Reflect.decorate&&typeof o!="object"&&Object.defineProperty(t,o,r),r);function Jo(t,o){return(r,e,i)=>{let n=(s)=>s.renderRoot?.querySelector(t)??null;if(o){let{get:s,set:l}=typeof e=="object"?r:i??(()=>{let c=Symbol();return{get(){return this[c]},set(p){this[c]=p}}})();return Y(r,e,{get(){let c=s.call(this);return c===void 0&&(c=n(this),(c!==null||this.hasUpdated)&&l.call(this,c)),c}})}return Y(r,e,{get(){return n(this)}})}}var m={bold:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 12a4 4 0 0 0 0-8H6v8"/><path d="M15 20a4 4 0 0 0 0-8H6v8Z"/></svg>`,italic:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>`,underline:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4v6a6 6 0 0 0 12 0V4"/><line x1="4" y1="20" x2="20" y2="20"/></svg>`,strike:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4H9a3 3 0 0 0-2.83 4"/><path d="M14 12a4 4 0 0 1 0 8H6"/><line x1="4" y1="12" x2="20" y2="12"/></svg>`,h1:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h8"/><path d="M4 18V6"/><path d="M12 18V6"/><path d="m17 12 3-2v8"/></svg>`,h2:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h8"/><path d="M4 18V6"/><path d="M12 18V6"/><path d="M21 18h-4c0-4 4-3 4-6 0-1.5-2-2.5-4-1"/></svg>`,list:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>`,listOrdered:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"/></svg>`,checklist:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="2"/><path d="m9 12 2 2 4-4"/></svg>`,link:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`,image:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>`,color:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16"/><path d="m6 16 6-12 6 12"/><path d="M8 12h8"/></svg>`,undo:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7v6h6"/><path d="M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13"/></svg>`,redo:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 7v6h-6"/><path d="M3 17a9 9 0 0 1 9-9 9 9 0 0 1 6 2.3L21 13"/></svg>`,alignLeft:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="15" y1="12" x2="3" y2="12"/><line x1="17" y1="18" x2="3" y2="18"/></svg>`,alignCenter:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="17" y1="12" x2="7" y2="12"/><line x1="19" y1="18" x2="5" y2="18"/></svg>`,alignRight:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="12" x2="9" y2="12"/><line x1="21" y1="18" x2="7" y2="18"/></svg>`,code:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>`,clear:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/></svg>`,edit:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>`,save:v`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>`};class Ht extends J{constructor(){super(...arguments);this.itemId=0;this.content="";this.isInternalEditing=!1;this.isDashboardEditing=!1}_unsubscribe;static styles=$t`
        :host {
            display: flex;
            flex-direction: column;
            width: 100%;
    ...
    `;connectedCallback(){super.connectedCallback(),this._unsubscribe=x.subscribe((o)=>{let r=this.isDashboardEditing;if(this.isDashboardEditing=o.isEditing||!1,r!==this.isDashboardEditing)if(this.isDashboardEditing)this.isInternalEditing=!1,this.requestUpdate();else this.loadFromStore()});let t=x.getState();this.isDashboardEditing=t.isEditing||!1,this.loadFromStore()}disconnectedCallback(){if(super.disconnectedCallback(),this._unsubscribe)this._unsubscribe()}updated(t){if(t.has("content")&&!this.isInternalEditing&&this.editorElement){if(this.editorElement.innerHTML!==this.content)this.editorElement.innerHTML=this.content||""}}loadFromStore(){if(!this.itemId)return;let o=x.getState().items.find((r)=>r.id===this.itemId);if(o)this.parseAndSetContent(o.content)}parseAndSetContent(t){try{let o=t;if(typeof t==="string")try{let r=JSON.parse(t);if(r&&typeof r==="object")o=r.text||""}catch(r){}else if(typeof t==="object")o=t.text||"";this.content=o||""}catch(o){this.content=""}}exec(t,o){if(document.execCommand(t,!1,o),this.editorElement)this.editorElement.focus()}saveContent(){try{let t=this.shadowRoot?.querySelector(".editor")||this.shadowRoot?.querySelector("[contenteditable]");if(!t)throw Error("Critical: Editor div missing");let o=t.innerHTML;this.content=o,this.isInternalEditing=!1,this.requestUpdate(),setTimeout(()=>{if(this.itemId){let r=x.getState().items.find((n)=>n.id===this.itemId),e={};try{e=typeof r?.content==="string"?JSON.parse(r.content):r?.content||{}}catch(n){console.warn("Failed to parse existing content",n)}let i={...e,text:o};x.updateItem({id:this.itemId,content:JSON.stringify(i)}).catch((n)=>console.error("[Store Update Failed]",n))}},0)}catch(t){console.error("[Notepad Save Error]",t),alert(a.t("widget.notepad.error.save")+t)}}startEditing(){if(this.isDashboardEditing)return;this.isInternalEditing=!0,setTimeout(()=>{if(this.editorElement){if(this.editorElement.focus(),this.editorElement.innerHTML!==this.content)this.editorElement.innerHTML=this.content||""}},0)}handleColor(t){let o=t.target;this.exec("foreColor",o.value)}handleToolbarWheel(t){t.preventDefault();let o=t.currentTarget;o.scrollLeft+=t.deltaY}insertChecklist(){let t="chk-"+Math.random().toString(36).substr(2,9),o=`<div style="display:flex; align-items:center; margin: 4px 0;"><input type="checkbox" id="${t}" style="margin-right:8px;"><label for="${t}">${a.t("widget.notepad.prompt.new_item")}</label></div>`;this.exec("insertHTML",o)}insertCode(){let o=`<pre style="background:rgba(0,0,0,0.3); padding:8px; border-radius:4px; font-family:monospace; margin:8px 0;"><code>${a.t("widget.notepad.prompt.code_block")}</code></pre><p><br></p>`;this.exec("insertHTML",o)}render(){try{if(!this.isInternalEditing)return v`
                ...
                <div class="container">
                    <div class="toolbar" @wheel="${this.handleToolbarWheel}" title="${a.t("widget.notepad.tool.scroll_hint")}">
                        <!-- History Group -->
                        <div class="group">
                             <button @click="${(t)=>{t.preventDefault(),this.exec("undo")}}" title="${a.t("widget.notepad.tool.undo")}">${m.undo}</button>
                             <button @click="${(t)=>{t.preventDefault(),this.exec("redo")}}" title="${a.t("widget.notepad.tool.redo")}">${m.redo}</button>
                        </div>
                        
                        <!-- Text Group -->
                        <div class="group">
                            <button @click="${(t)=>{t.preventDefault(),this.exec("formatBlock","H1")}}" title="${a.t("widget.notepad.tool.h1")}">${m.h1}</button>
                            <button @click="${(t)=>{t.preventDefault(),this.exec("formatBlock","H2")}}" title="${a.t("widget.notepad.tool.h2")}">${m.h2}</button>
                            <button @click="${(t)=>{t.preventDefault(),this.exec("bold")}}" title="${a.t("widget.notepad.tool.bold")}">${m.bold}</button>
                            <button @click="${(t)=>{t.preventDefault(),this.exec("italic")}}" title="${a.t("widget.notepad.tool.italic")}">${m.italic}</button>
                            
                            <!-- Color Picker -->
                            <div class="color-wrapper">
                                <button title="${a.t("widget.notepad.tool.color")}">${m.color}</button>
                        ...
                        <!-- Paragraph Group -->
                        <div class="group">
                             <button @click="${(t)=>{t.preventDefault(),this.exec("justifyLeft")}}" title="${a.t("widget.notepad.tool.align_left")}">${m.alignLeft}</button>
                             <button @click="${(t)=>{t.preventDefault(),this.exec("justifyCenter")}}" title="${a.t("widget.notepad.tool.align_center")}">${m.alignCenter}</button>
                             <button @click="${(t)=>{t.preventDefault(),this.exec("justifyRight")}}" title="${a.t("widget.notepad.tool.align_right")}">${m.alignRight}</button>
                        </div>
                        
                        <div class="group">
                            <button @click="${(t)=>{t.preventDefault(),this.insertChecklist()}}" title="${a.t("widget.notepad.tool.checklist")}">${m.checklist}</button>
                            <button @click="${(t)=>{t.preventDefault(),this.exec("insertUnorderedList")}}" title="${a.t("widget.notepad.tool.list_bullet")}">${m.list}</button>
                            <button @click="${(t)=>{t.preventDefault(),this.exec("insertOrderedList")}}" title="${a.t("widget.notepad.tool.list_ordered")}">${m.listOrdered}</button>
                        </div>

                        <!-- Insert Group -->
                        <div class="group">
                            <button @click="${(t)=>{t.preventDefault(),this.insertCode()}}" title="${a.t("widget.notepad.tool.code")}">${m.code}</button>
                            <button @click="${(t)=>{t.preventDefault();let o=prompt(a.t("widget.notepad.prompt.url"));if(o)this.exec("createLink",o)}}" title="${a.t("widget.notepad.tool.link")}">${m.link}</button>
                            <button @click="${(t)=>{t.preventDefault();let o=prompt(a.t("widget.notepad.prompt.image_url"));if(o)this.exec("insertImage",o)}}" title="${a.t("widget.notepad.tool.image")}">${m.image}</button>
                             <button @click="${(t)=>{t.preventDefault(),this.exec("removeFormat")}}" title="${a.t("widget.notepad.tool.clear_format")}">${m.clear}</button>
                        </div>
                    </div>
                    ...
                    <button class="fab-btn save-btn" @click="${this.saveContent}" title="${a.t("widget.notepad.tool.save")}">${m.save}</button>
                </div>
            `}catch(t){return v`
        ...
        `,this.cpuBar=this.shadowRoot.querySelector(".cpu-bar"),this.ramBar=this.shadowRoot.querySelector(".ram-bar"),this.tempBar=this.shadowRoot.querySelector(".temp-bar"),this.cpuText=this.shadowRoot.querySelector(".cpu-text"),this.ramText=this.shadowRoot.querySelector(".ram-text"),this.tempText=this.shadowRoot.querySelector(".temp-text")}}customElements.define("widget-telemetry",Yo);var Qo=`:host {
...
`;class tr extends HTMLElement{icons=[];filteredIcons=[];selectedIcon="";searchQuery="";isLoading=!0;debounceTimer=null;inputElement=null;id_debug=Math.random().toString(36).substr(2,5);constructor(){super();this.attachShadow({mode:"open"})}async connectedCallback(){if(this.shadowRoot.childElementCount>0)return;if(this.renderBase(),this.setupListeners(),this.icons.length===0)await this.loadIcons()}async loadIcons(){try{this.icons=await Bt.loadIcons(),this.filteredIcons=this.icons.slice(0,50),this.isLoading=!1,this.updateGrid()}catch(t){console.error(`[IconPicker:${this.id_debug}] Failed to load icons`,t),this.isLoading=!1,this.updateGrid()}}setupListeners(){let t=this.shadowRoot;this.inputElement=t.getElementById("icon-search"),this.inputElement?.addEventListener("input",(r)=>{let e=r.target;if(this.searchQuery=e.value,this.debounceTimer)window.clearTimeout(this.debounceTimer);this.debounceTimer=window.setTimeout(()=>{this.performSearch()},100)}),t.getElementById("grid-container")?.addEventListener("click",(r)=>{let i=r.target.closest(".icon-picker__item");if(i&&i.dataset.icon)this.selectedIcon=i.dataset.icon,this.updateSelected(),this.updateGrid(),this.dispatchEvent(new CustomEvent("icon-selected",{detail:{iconName:this.selectedIcon},bubbles:!0,composed:!0}))})}performSearch(){this.filteredIcons=Bt.searchIcons(this.searchQuery,50),this.updateGrid()}getSelectedIcon(){return this.selectedIcon}setSelectedIcon(t){this.selectedIcon=t,this.updateSelected(),this.updateGrid()}renderBase(){this.shadowRoot.innerHTML=`
            <style>${Io}</style>
            ${Vo()}
        `}updateGrid(){let t=this.shadowRoot.getElementById("grid-container");if(t){if(!this.searchQuery.trim()&&!this.isLoading){t.style.display="none",t.innerHTML="";return}t.style.display="grid",t.innerHTML=Wo(this.filteredIcons,this.selectedIcon,this.isLoading)}}updateSelected(){let t=this.shadowRoot.getElementById("selected-container");if(t)t.innerHTML=Po(this.selectedIcon)}}if(!customElements.get("icon-picker"))customElements.define("icon-picker",tr);var or=({isOpen:t,isEditMode:o})=>`
...
.btn-confirm:active {
    transform: translateY(0);
            ...
            <style>${sr}</style>
            ${nr({isOpen:this.isOpen,title:this.titleText,message:this.messageText})}
        `,this.setupDynamicListeners()}}if(!customElements.get("confirmation-modal"))customElements.define("confirmation-modal",lr);async function cr(t){try{await a.ensureInitialized(),await t()}catch(o){console.error("[Bootstrap] Critical failure:",o),document.body.innerHTML=`
            <div style="
                display: flex; 
                flex-direction: column; 
                align-items: center; 
        ...
        `}}bt();var T=document.getElementById("main-topbar"),dr=document.getElementById("right-drawer"),vt=document.getElementById("dashboard-root"),D,_t,mt;cr(async()=>{if(U.init(),await k.fetchUser(),T){let o=k.getUser();if(T.setState({user:o}),o&&o.project_name)T.setAttribute("title",o.project_name);k.subscribe((r)=>{if(r){if(T.setState({user:r}),r.project_name)T.setAttribute("title",r.project_name)}})}await x.fetchItems(),Yr(),P.start(),D=document.createElement("add-bookmark-modal"),document.body.appendChild(D),_t=document.createElement("add-widget-modal"),document.body.appendChild(_t),mt=document.createElement("confirmation-modal"),document.body.appendChild(mt);let t=document.createElement("widget-config-modal");document.body.appendChild(t)});st.on(nt.SHOW_CONFIRMATION,async(t)=>{let{title:o,message:r,onConfirm:e}=t.detail;if(mt){if(await mt.confirm(o,r)&&e)e()}});st.on(nt.SHOW_WIDGET_CONFIG,(t)=>{let{item:o,type:r}=t.detail;if(r==="bookmark"){if(D)D.openForEdit(o)}else{let e=document.querySelector("widget-config-modal");if(e)e.open(o)}});st.on(nt.NOTIFY,(t)=>{let o=document.querySelector("app-notifier");if(o)o.show(t.detail.message,t.detail.type)});if(T)T.addEventListener("drawer-toggle",(t)=>{if(t.detail.action==="open")dr.open(),T.setState({drawerOpen:!0});else dr.close(),T.setState({drawerOpen:!1})}),T.addEventListener("edit-mode-change",(t)=>{let o=t.detail.active;if(vt.classList.toggle("edit-mode",o),!o)window.location.reload()}),T.addEventListener("search-input",(t)=>{let o=t.detail.query;x.setSearchQuery(o)}),T.addEventListener("add-item",(t)=>{let o=t.detail.action;if(o==="add-bookmark"){if(D)D.open()}else if(o==="add-widget"){if(_t)_t.open()}else if(o==="add-section"){let e=x.getState().items||[];Promise.resolve().then(() => (Z(),V)).then(({collisionService:i})=>{let n=i.findFirstAvailableSlot(1,1,e),s={type:"section",x:n.x,y:n.y,w:1,h:1,content:JSON.stringify({name:""})};x.addItem(s)})}});window.addEventListener("widget-selected",(t)=>{let r=t.detail,i=x.getState().items||[];Promise.resolve().then(() => (Z(),V)).then(({collisionService:n})=>{let s=n.findFirstAvailableSlot(r.defaultW,r.defaultH,i),l={type:"widget",x:s.x,y:s.y,w:r.defaultW,h:r.defaultH,content:JSON.stringify({widgetId:r.id,text:r.id==="notepad"?"":void 0})};x.addItem(l)})});window.addEventListener("drawer-close",()=>{if(T)T.setState({drawerOpen:!1})});window.addEventListener("click",(t)=>{let o=t.target,r=document.getElementById("add-menu"),e=document.getElementById("add-toggle");if(r&&r.classList.contains("active")&&!r.contains(o)&&e&&!e.contains(o))r.classList.remove("active")});function Yr(){if(!vt)return;vt.innerHTML="";let t=document.createElement("bookmark-grid");vt.appendChild(t)}
