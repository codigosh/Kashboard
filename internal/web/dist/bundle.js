...
.right-drawer__menu-item--logout:hover {
    background: rgba(var(--danger-rgb), 0.05) !important;
        ...
        `}}if(!customElements.get("app-right-drawer"))customElements.define("app-right-drawer",Vr);u();var Or=({title:o,editMode:r,searchActive:i,addMenuActive:t,drawerOpen:a,searchQuery:n,user:d,updateAvailable:c})=>{return`
    <div class="top-bar">
...
@keyframes pulse {
    ...
    50% {
        opacity: 1;
            ...
            <style>${Ci}</style>
            ${Xi()}
        `}updateGrid(){let o=this.shadowRoot.getElementById("grid-container");if(o){if(!this.searchQuery.trim()&&!this.isLoading){o.style.display="none",o.innerHTML="";return}o.style.display="grid",o.innerHTML=Ri(this.filteredIcons,this.selectedIcon,this.isLoading)}}updateSelected(){let o=this.shadowRoot.getElementById("selected-container");if(o)o.innerHTML=Li(this.selectedIcon)}}if(!customElements.get("icon-picker"))customElements.define("icon-picker",Wi);u();var Ti=({isOpen:o,isEditMode:r})=>`
    <dialog id="modal">
        <div class="modal-header">
