...
.paper {
    ...
    height: 100%;
            ...
            <style>${qo}</style>
            ${Bo()}
        `}}if(!customElements.get("app-paper"))customElements.define("app-paper",Ho);var Co=`:host {
...
.avatar__initials {
    user-select: none;
            ...
            <style>${Fo}</style>
            ${Ro({src:o||void 0,initials:t,alt:r})}
        `}}if(!customElements.get("app-avatar"))customElements.define("app-avatar",Eo);f();J();no();f();var Qo=(o)=>`
...
(max-width: 1024px) {
    ...
    .header__profile-container {
        ...
        `}}if(!customElements.get("app-header"))customElements.define("app-header",tt);f();var U=(o)=>String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),St=(o)=>{if(!o)return"#";let t=o.trim().toLowerCase();if(t.startsWith("http://")||t.startsWith("https://")||t==="#")return U(o);return"#"},rt=({bookmarks:o,isEditing:t,isLoading:r,isSearching:i,isTouchDevice:n,maxCols:e=12})=>{let s=Array.isArray(o)?o:[];if(r&&s.length===0)return tr(e);let d=(c)=>s.filter((l)=>l.parent_id===c);return`
    ${(n?s:i?s:s.filter((c)=>!c.parent_id)).map((c)=>{let l={};try{l=typeof c.content==="string"?JSON.parse(c.content):c.content}catch(y){console.error("Failed to parse content for item",c.id,y)}let x=c.type==="section",w={x:c.x||1,y:c.y||1},u=Math.min(c.w||1,e),_=c.h||1;if(x){let y=d(c.id),m=(l.title||"").trim();return`
            <fieldset class="bookmark-grid__section"
               ...
               `:""}
            </fieldset>`}return it(c,l,t,w,u,_,n)}).join("")}

    <div id="ghost-element" class="bookmark-grid__ghost" style="display: none;"></div>
    `};function it(o,t,r,i,n,e=0,s=!1){let d=e||o.h||1;if(o.type==="widget"){let y=t.widgetId,b={clock:"widget-clock",notepad:"widget-notepad",telemetry:"widget-telemetry",weather:"widget-weather",markdown:"widget-markdown"}[y]||"div",A=(t.text||"").replace(/"/g,"&quot;");return`
    ...
    `}let p=t.icon||"",l=p.startsWith("http")||p.startsWith("/")?`<img src="${U(p)}" alt="${U(t.label)}" class="bookmark-grid__icon-img" draggable="false" />`:p?U(p):'<svg class="bookmark-grid__icon-svg" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',x=r?'role="button"':`href="${St(t.url)}" target="_blank"`,w=!s?`--x: ${i.x}; --y: ${i.y}; --w: ${n}; --h: ${d};`:"",u=t.borderColor&&!r?`border-color: ${t.borderColor} !important;`:"",_=t.labelPos==="top"?"label-top":t.labelPos==="section"?"label-section":t.labelPos==="off"?"label-off":"";return`
        <a ${x} class="bookmark-grid__card ${_}"
           draggable="${r}"
           data-id="${o.id}"
           data-type="${o.type}"
           data-orig-x="${o.x}" data-orig-y="${o.y}"
    ...
    `}function or(o,t,r=!1,i=12,n=!1){return o.map((e)=>{let s={};try{s=typeof e.content==="string"?JSON.parse(e.content):e.content}catch(l){console.error("Failed to parse content for item (nested)",e.id,l)}let d={x:e.x||1,y:e.y||1},p=e.h||1,c=Math.min(e.w||1,i);return it(e,s,t,d,c,p,n)}).join("")}function tr(o){return`
        <style>
            .skeleton {
                background: var(--surface);
                pointer-events: none;
...
`;class nt extends HTMLElement{_itemId=0;_content="";_isDirty=!1;_isLocked=!0;_isSaving=!1;_lastLockTime=0;_editor=null;_syncStatus=null;_dock=null;_editorContainer=null;_modal=null;_imgResizer=null;_activeImage=null;_pendingAction=null;static get observedAttributes(){return["item-id"]}constructor(){super();this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.loadContent(),window.addEventListener("beforeunload",this.handleBeforeUnload.bind(this)),a.subscribe(()=>{if(this._editor)this._editor.dataset.placeholder=a.t("widget.notepad.placeholder")})}disconnectedCallback(){window.removeEventListener("beforeunload",this.handleBeforeUnload.bind(this))}attributeChangedCallback(o,t,r){if(o==="item-id")this._itemId=parseInt(r),this.loadContent()}handleBeforeUnload(o){if(this._isDirty)o.preventDefault(),o.returnValue=""}render(){if(!this.shadowRoot)return;let o=this._isLocked?"locked":"unlocked",t=this._isLocked?"locked":"",r=this._isLocked?"hidden":"";this.shadowRoot.innerHTML=`
        ...
        `,this.cpuBar=this.shadowRoot.querySelector(".cpu-bar"),this.ramBar=this.shadowRoot.querySelector(".ram-bar"),this.tempBar=this.shadowRoot.querySelector(".temp-bar"),this.cpuText=this.shadowRoot.querySelector(".cpu-text"),this.ramText=this.shadowRoot.querySelector(".ram-text"),this.tempText=this.shadowRoot.querySelector(".temp-text")}}customElements.define("widget-telemetry",et);f();M();var st=new Map,pt=900000,dt={widgetId:"weather",latitude:0,longitude:0,city:"",unit:"celsius",showForecast:!1,forecastDays:5};function O(o){if(o===0)return`<svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
        ...
        `}forecastView(o,t,r){let i=a.getLocale().code,n=Math.min(this._config.forecastDays||5,t.time.length-1),e="";for(let s=1;s<=n;s++){let d=new Date(t.time[s]+"T00:00:00"),p=d.toLocaleDateString(i,{weekday:"short"}),c=d.toLocaleDateString(i,{weekday:"long",day:"numeric",month:"long"}),l=xo(t.weathercode[s]),x=F(t.temperature_2m_max[s],r),w=F(t.temperature_2m_min[s],r),u=t.sunrise?.[s]?.split("T")[1]||"",_=t.sunset?.[s]?.split("T")[1]||"",y=t.wind_speed_10m_max?.[s]!=null?`${Math.round(t.wind_speed_10m_max[s])} km/h`:"";e+=`<div class="fc-day">
                ...
                <div class="fc-tooltip">
                    ...
                    <div class="tt-row"><span class="tt-label">${a.t("widget.weather.max_min")}</span><span>${x} / ${w}</span></div>
            ...
            <div class="fc-header">
                ...
                <div class="fc-h-info">
                    <div class="fc-h-temp">${F(o.temperature,r)}</div>
                    <div class="fc-h-desc">${xo(o.weathercode)}</div>
                </div>
                ${this._config.city?`<div class="fc-h-city">${this._config.city}</div>`:""}
            </div>
            <div class="minmax compact"><span class="hi">${F(t.temperature_2m_max[0],r)}</span><span class="lo">${F(t.temperature_2m_min[0],r)}</span></div>
    ...
    <div class="form-group" style="margin-top: 12px;">
        ...
        <div class="input-group">
            <button type="button" class="icon-dropdown-btn color-trigger-btn" id="color-btn" style="position: relative; justify-content: flex-start; padding: 0 12px; gap: 12px;">
                <div class="color-preview-circle" style="background: ${o}; width: 18px; height: 18px; border-radius: 50%; border: 1px solid var(--border-bright);"></div>
                <span style="font-size: 13px; font-weight: 500; font-family: var(--font-mono, monospace); color: var(--text-dim);">${o.toUpperCase()}</span>
                <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="position: absolute; bottom: 1px; right: 1px; opacity: 0.7;">
                    <path d="M7 10l5 5 5-5z" />
                </svg>
            </button>
            <input type="color" id="bookmark-borderColor" name="borderColor" value="${o}" style="display: none;" />
        </div>
    </div>
`,pr=["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#64748b","#f8fafc","#1e293b","#333333"],wt=({isOpen:o,isEditMode:t,title:r,url:i,protocol:n,selectedIcon:e,color:s,statusPosition:d,checkStatus:p,labelPosition:c,visibleTouch:l})=>`
    <dialog id="modal">
        <div class="modal-header">
        ...
        <div id="menu-overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 9999;">
            ...
            <div class="dropdown-menu color-menu" id="color-menu" style="width: 200px; padding: 12px;">
                <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; margin-bottom: 12px;">
                    ${pr.map((x)=>`
                        <div class="color-preset ${s===x?"selected":""}" 
                             data-color="${x}" 
                             style="background: ${x}; width: 28px; height: 28px; border-radius: 6px; cursor: pointer; border: 1px solid var(--border); transition: all 0.2s;"
                             title="${x}">
                        </div>
                    `).join("")}
                </div>
                <div class="dropdown-item custom-color-item" data-color="custom" style="justify-content: center; gap: 8px; font-size: 12px; font-weight: 500; border-top: 1px solid var(--border); margin-top: 4px; padding-top: 8px;">
                    ...
                    <span>${a.t("bookmark.custom_color")||"Custom Color"}</span>
                </div>
            </div>
        </div>
    </dialog>
...
.custom-color-item:hover {
    ...
    background: rgba(var(--accent-rgb), 0.1);
            ...
            `;let s=o.getElementById("bookmark-labelPos");if(s)s.value=this.labelPosition;o.querySelectorAll("#label-pos-menu .dropdown-item").forEach((d)=>{d.classList.toggle("selected",d.dataset.pos===this.labelPosition)})}let r=o.getElementById("status-pos-btn");if(r){r.innerHTML=`
            ...
            `;let s=o.getElementById("bookmark-statusPos");if(s)s.value=this.checkStatus?this.statusPosition:"off";o.querySelectorAll("#status-pos-menu .dropdown-item").forEach((d)=>{let p=d.dataset.statusPos,c=p==="off"?!this.checkStatus:this.checkStatus&&p===this.statusPosition;d.classList.toggle("selected",c)})}let i=o.getElementById("protocol-text");if(i){i.textContent=this.protocol;let s=o.getElementById("bookmark-protocol");if(s)s.value=this.protocol;o.querySelectorAll("#protocol-menu .dropdown-item").forEach((d)=>{d.classList.toggle("selected",d.dataset.protocol===this.protocol)})}let n=o.getElementById("touch-pos-btn");if(n){n.innerHTML=`
                ${this.visibleTouch?'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="7" y="2" width="10" height="20" rx="2" stroke-opacity="0.5" /><path d="M12 18h.01" stroke-width="3" stroke-linecap="round" /></svg>':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="7" y="2" width="10" height="20" rx="2" stroke-opacity="0.5" /><path d="M12 18h.01" stroke-width="3" stroke-linecap="round" /><path d="M5 5l14 14" opacity="0.7" /></svg>'}
                <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="position: absolute; bottom: 1px; right: 1px; opacity: 0.7;">
                    <path d="M7 10l5 5 5-5z" />
                </svg>
            `;let s=o.getElementById("bookmark-visibleTouch");if(s)s.value=this.visibleTouch?"on":"off";o.querySelectorAll("#touch-pos-menu .dropdown-item").forEach((d)=>{let p=d.dataset.touch;d.classList.toggle("selected",p==="on"&&this.visibleTouch||p==="off"&&!this.visibleTouch)})}let e=o.getElementById("color-btn");if(e){e.innerHTML=`
...
@keyframes fadeContent {
    ...
    to {
        ...
        transform: translateY(0);
                ...
                `;return{general:u,customization:_}}else if(t==="telemetry"){let d=o.interval||1000,p=`
                ...
                `;return{general:p,customization:c}}return{general:`<p>${a.t("widget.config.no_config")}</p>`,customization:""}},n=()=>{if(this.currentItem?.type==="section")return a.t("section.edit_title");return a.t("widget.config.title")},e=i();this.shadowRoot.innerHTML=`
            <style>${At}</style>
            <dialog id="modal">
                <div class="modal-header">
                    <div class="integrated-tabs">
